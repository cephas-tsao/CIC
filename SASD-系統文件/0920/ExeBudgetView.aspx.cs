            ...
            if (CheckBoxList2.SelectedValue == "")
            {
                ...
                if (vsDt.Rows.Count > 0)
                {
                 ...
                 <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                        ...
                        tmpStr3.AppendLine(string.Format(ListStr2, LbWid, LbPriceID, Orderlayer, order, LbItemName, LbUnit, LbCNumber, LbEPrice, LbCComplex, ChAmount, LbNotes, Link, Link1));
                    ...
                    if (item1.Selected == true)
                    {
                        ...
                        if (vsDt1.Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < vsDt1.Rows.Count; i++)
                            {
                                ...
                                string ListStr3 = @"<tr class=""TableSingle"">
                                 <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                                <Label ID=""LbPriceID"" Visible=""false"" Text=""{1}""></Label>
                                {2}{3}
                                <td class=""autoLeft"">{4}</td>
                                ...
                                <td class=""auto-style83"">{7}</td>
                                <td class=""auto-style83"">{8}</td>";
                                tmpStr2.AppendLine(string.Format(ListStr3, LbWid1, LbPriceID1, Orderlayer1, order1, LbItemName1, LbUnit1, LbCNumber1, LbEPrice1, LbCComplex1,Link, Link1));
