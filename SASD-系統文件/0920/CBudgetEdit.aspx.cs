    ...
    public partial class CBudgetEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //DDL_Unit.DataBind();
                //Lbl_Box0.Text = DAL.WebModel.Get_Item_List1(Session["DatabaseName"].ToString());
                    ...
                    if (DataTableBox1 != null && DataTableBox1.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in DataTableBox1.Rows)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    PlaceHolder2.Controls.Add(new LiteralControl("<td style='padding-left:10px;width:90px'>"));
