<%@ Page Language="C#" AutoEventWireup="true" CodeFile="請款2.aspx.cs" Inherits="請款2" %>
        ...
        <table class="Table100">
            <tr>
                ...
                <td class="Table0R" width="20%">
                    <asp:Button ID="Button15" runat="server" CssClass="BtnFree" Text="新增請款單" />
                </td>
            </tr>
            </table>
        <table class="Table100">
            ...
            <tr>
                <td class="Table2CC">
                    <asp:Button ID="Button3" runat="server" CssClass="BtnFree" Text="編輯" OnClick="Button3_Click" />
                </td>
            ...
            <tr>
                <td class="Table2R" colspan="9">
                    註：已填寫領款日期之請款單視為已完成請款動作，不得編輯修改。</td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <table class="Table100">
                    ...
                    <tr>
                        ...
                        <td class="Table2CC">3,580,000</td>
                        <td class="Table2CC">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="Table1" colspan="7">
                            ...
                            &nbsp;
                            <asp:Button ID="Button16" runat="server" CssClass="BtnLargeMedium" Text="刪除請款單" />
                        </td>
                    </tr>
                </table>
        </asp:Panel>
