<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EReallocation_1.aspx.cs" Inherits="EReallocation_1" %>
    ...
    <div>
		...
		<td class="Table2C" colspan="7">
                                <table class="Sht100">
                                    ...
                                    <asp:ImageButton ID="ImageButton191" runat="server" Height="30px" ImageUrl="~/img/ArrowDOWN.jpg" ToolTip="下移" Width="27px" />
                                            </td>
                                        <td class="ShtCellCC">
                                    ...
                                    <asp:ImageButton ID="ImageButton192" runat="server" Height="30px" ImageUrl="~/img/ArrowDOWN.jpg" ToolTip="下移" Width="27px" />
                                    ...
                                    <tr class="ShtRowSingle">
                                        <td class="ShtCellCC">
                                    <asp:ImageButton ID="ImageButton190" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="移除子項" Width="27px" PostBackUrl="~/EReallocation_1b.aspx" />
