<%@ Page Language="C#" AutoEventWireup="true" CodeFile="執預3_3.aspx.cs" Inherits="執預3" %>
                        ...
                        <table border="1" class="Table1">
                            ...
                            <tr class="TableSingle">
                                ...
                                <td class="auto-style40" colspan="3" align="center">
                                    <asp:Label ID="Label296" runat="server" Text="二" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoLeft">
                            ...
                            <tr class="TableExecute">
                                ...
                                <td class="ShtCellCR">
                                    350</td>
                                <td class="ShtCellCR">
                                    <asp:Label ID="Label488" runat="server" Font-Names="微軟正黑體" Format="{0:N4}">3,045</asp:Label>
                                </td>
                                <td class="ShtCellCR">
                                    1,065,750</td>
                                <td class="autoRight">
                            ...
                            <tr class="TableExecute">
                                ...
                                <td class="ShtCellCR">
                                    350</td>
                                <td class="ShtCellCR">
                                    <asp:Label ID="Label489" runat="server" Font-Names="微軟正黑體" Format="{0:N4}">3,045</asp:Label>
                                </td>
                                <td class="ShtCellCR">
                                    1,065,750</td>
                                <td class="autoRight">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    ...
                                    <asp:ImageButton ID="ImageButton250" runat="server" Height="30px" ImageUrl="~/img/Edit.png" ToolTip="逐項編輯" Width="27px" />
                                    <asp:ImageButton ID="ImageButton239" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55" colspan="2">4</td>
                                <td class="autoLeft">
                                    <asp:Label ID="Label472" runat="server" Height="25px" Text="結構用混凝土，預拌，210kgf/cm2，第1型水泥" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label473" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton234" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton235" runat="server" Height="30px" ImageUrl="~/img/NumBD.png" ToolTip="拆數量" Width="27px" />
                                ...
                                <td class="autoLeft">
                                    <asp:Label ID="Label474" runat="server" Height="25px" Text="結構用混凝土，預拌，245kgf/cm2，第1型水泥" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label475" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton236" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    ...
                                    <asp:ImageButton ID="ImageButton251" runat="server" Height="30px" ImageUrl="~/img/Edit.png" ToolTip="逐項編輯" Width="27px" />
                                    <asp:ImageButton ID="ImageButton241" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                ...
                                <td class="autoLeft">
                                    1F-245混凝土</td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label476" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton237" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton240" runat="server" Height="30px" ImageUrl="~/img/Reallocation.png" ToolTip="拆工料" Width="27px" />
                                    <asp:ImageButton ID="ImageButton252" runat="server" Height="30px" ImageUrl="~/img/Edit.png" ToolTip="逐項編輯" Width="27px" />
                                    <asp:ImageButton ID="ImageButton242" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                ...
                                <td class="autoLeft">
                                    2F-245混凝土</td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label477" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton238" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton246" runat="server" Height="30px" ImageUrl="~/img/Reallocation.png" ToolTip="拆工料" Width="27px" />
                                    <asp:ImageButton ID="ImageButton253" runat="server" Height="30px" ImageUrl="~/img/Edit.png" ToolTip="逐項編輯" Width="27px" />
                                    <asp:ImageButton ID="ImageButton247" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55" colspan="2">6</td>
                                <td class="autoLeft">
                                    <asp:Label ID="Label478" runat="server" Height="25px" Text="結構用混凝土，預拌，280kgf/cm2，第1型水泥" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label479" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton243" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton248" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">6.1</td>
                                <td class="autoLeft">
                                    280混凝土材料費</td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label480" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton244" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
                            ...
                            <tr class="TableNewExecute">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton249" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" />
                                </td>
                                <td style="width: 3px">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                                <td class="auto-style55">6.2</td>
                                <td class="autoLeft">
                                    280混凝土工</td>
                                <td class="autoCenter">
                                    <asp:Label ID="Label481" runat="server" Text="M3" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton245" runat="server" Height="30px" ImageUrl="~/img/Ana.jpg" Width="30px" ToolTip="檢視單價分析" />
                                </td>
                                <td class="ShtCellCR">
                                    &nbsp;</td>
                                <td class="ShtCellCR">
