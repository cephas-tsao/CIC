<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExeBudgetPEdit_1.aspx.cs" Inherits="ExeBudgetPEdit_1" %>
...
<body>
    ...
    <div>
		...
		<td class="auto-style2L" width="50%">
                                    &nbsp;
                                <asp:ImageButton ID="ImageButton214" runat="server" Height="30px" ImageUrl="~/img/WorkItem.png" ToolTip="返回工項編輯" Width="27px" PostBackUrl="~/ExeBudgetEdit_3.aspx" />
                                &nbsp;
                        ...
                        <table border="1" class="Table1">
                            ...
                            <tr class="TableDouble">
                                ...
                                <td class="auto-style98">
                                    xx.xx</td>
                                <td class="auto-style98">
                                    <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton2_Click">2,500</asp:LinkButton>
                                    </td>
                                <td class="auto-style97">
