<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivitySetting.aspx.cs" Inherits="ActivitySetting" %>
                        ...
                        <table id="ActivityTable" border="1" class="Sht100">
                            ...
                            <tr class="ShtRowDouble">
                                <td class="ShtCellCC">
                                    ...
                                    <asp:ImageButton ID="IBtn_D2" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除作業項目" Width="27px" PostBackUrl="~/ActivitySetting_2.aspx" />
                                </td>
                                <td class="ShtCellCC">
                                    2</td>
                                <td class="ShtCellCL">
