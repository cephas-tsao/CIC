<%@ Page Language="C#" AutoEventWireup="true" CodeFile="包商5.aspx.cs" Inherits="包商5" %>
    ...
    <div>
        ...
        <table class="Sht100">
            ...
            <tr class="ShtRowDouble">
                ...
                <td class="ShtCellCC" colspan="5">
                    <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="100%">
                        <asp:ListItem Value="16">優</asp:ListItem>
                        <asp:ListItem Value="12">良</asp:ListItem>
                        <asp:ListItem Value="8">可</asp:ListItem>
                        <asp:ListItem Value="4">差</asp:ListItem>
            ...
            <tr class="ShtRowSingle">
                ...
                <td class="ShtCellCC" colspan="5">
                    <asp:RadioButtonList ID="RadioButtonList3" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="100%">
                        <asp:ListItem Value="16">優</asp:ListItem>
                        <asp:ListItem Value="12">良</asp:ListItem>
                        <asp:ListItem Value="8">可</asp:ListItem>
                        <asp:ListItem Value="4">差</asp:ListItem>
            ...
            <tr class="ShtRowDouble">
                ...
                <td class="ShtCellCC" colspan="5">
                    <asp:RadioButtonList ID="RadioButtonList4" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="100%">
                        <asp:ListItem Value="16">優</asp:ListItem>
                        <asp:ListItem Value="12">良</asp:ListItem>
                        <asp:ListItem Value="8">可</asp:ListItem>
                        <asp:ListItem Value="4">差</asp:ListItem>
            ...
            <tr class="ShtRowSingle">
                ...
                <td class="ShtCellCC" colspan="5">
                    <asp:RadioButtonList ID="RadioButtonList5" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="100%">
                        <asp:ListItem Value="16">優</asp:ListItem>
                        <asp:ListItem Value="12">良</asp:ListItem>
                        <asp:ListItem Value="8">可</asp:ListItem>
                        <asp:ListItem Value="4">差</asp:ListItem>
            ...
            <tr class="ShtRowDouble">
                ...
                <td class="ShtCellCC" colspan="5">
                    <asp:RadioButtonList ID="RadioButtonList6" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Width="100%">
                        <asp:ListItem Value="16">優</asp:ListItem>
                        <asp:ListItem Value="12">良</asp:ListItem>
                        <asp:ListItem Value="8">可</asp:ListItem>
                        <asp:ListItem Value="4">差</asp:ListItem>
            ...
            <tr class="ShtRowExecuteSoft">
                ...
                <td class="ShtCellCL">
                    考核結果：<asp:Literal ID="LtResult" runat="server"></asp:Literal>
                </td>
