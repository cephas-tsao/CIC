<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubBudgetAdd.aspx.cs" Inherits="SubBudgetAdd" %>
                                            ...
                                            <td class="Sht50" valign="top">
                                                <table class="Sht100">
                                                    ...
                                                    <tr class="ShtRowSingle">
                                                        ...
                                                        <td class="ShtCellCR">5,000,000</td>
                                                        <td class="ShtCellCR">1</td>
                                                        <td class="ShtCellCC">
                                                    ...
                                                    <tr class="ShtRowDouble">
                                                        ...
                                                        <td class="ShtCellCC">式</td>
                                                        <td class="ShtCellCR">1</td>
                                                        <td class="ShtCellCR">1,000,000</td>
                                                        <td class="ShtCellCR">1</td>
                                                        <td class="ShtCellCC">
                                                    ...
                                                    <tr class="ShtRowExecuteSoft">
                                                        ...
                                                        <td class="ShtCellCR">1,813</td>
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox58" runat="server" CssClass="TBshort">1000</asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
