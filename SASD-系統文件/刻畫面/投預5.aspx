<%@ Page Language="C#" AutoEventWireup="true" CodeFile="投預5.aspx.cs" Inherits="投預5" %>
...
<body>
	...
	<table style="width: 100%">
        ...
        <table style="width: 100%">
        <tr>
			<td class="auto-style1" colspan="2">投標預算單價填列</td>
		</tr>
		<tr>
		...
		<td class="auto-style15">
                        ...
                        <table border="1" class="Table1">
                            <tr class="TableTop">
                                ...
                                <td class="auto-style45">原標單<br /> 工程用量</td>
                                <td class="auto-style45">校核後<br /> 工程用量</td>
                                <td class="auto-style45">單價</td>
                                <td class="auto-style45" colspan="2">調整後單價</td>
                                <td class="auto-style45">詢報價作業</td>
                            </tr>
                            ...
                            <tr class="TableSingle">
                                ...
                                <td class="autoCenter">
                                    ...
                                    &nbsp;<asp:ImageButton ID="ImageButton176" runat="server" Height="30px" ImageUrl="~/img/Q1.png" ToolTip="查詢詢報價作業" Width="27px" />
                                </td>
                            </tr>
                            <tr class="TableDouble">
                                <td class="autoLeft">
                                ...
                                <td class="autoCenter">
                                    &nbsp;</td>
                                <td class="autoCenter">
                                    <asp:ImageButton ID="ImageButton177" runat="server" Height="30px" ImageUrl="~/img/PAsk.jpg" ToolTip="新增詢價單" Width="30px" />
