<%@ Page Language="C#" AutoEventWireup="true" CodeFile="竣工3.aspx.cs" Inherits="竣工3" %>
            ...
            <table class="Table100">
                <tr>
                    ...
                    <td class="Table2">
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem>全部驗收</asp:ListItem>
                ...
                <tr>
                    ...
                    <td class="Table2" colspan="9">
                        <asp:TextBox ID="TextBox12" runat="server" CssClass="TB500" Height="154px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="Table1" colspan="10">
                        <asp:Button ID="Button1" runat="server" CssClass="BtnLargeShort" Text="確定新增" />
                        &nbsp;
        ...
        <asp:Panel ID="Pnl_View" runat="server">
            <asp:GridView ID="GridView2" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="AcceptID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="Button3" runat="server" CssClass="BtnFree" Text="編修" OnClick="Button3_Click" />
                        </ItemTemplate>
                ...
                <table class="Table100">
                    <tr>
                        <td class="Table0" colspan="10">
                            <asp:LinkButton ID="LinkButton4" runat="server" ForeColor="White">單筆驗收紀錄編修</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td class="Table1">驗收種類</td>
                    ...
                    <tr>
                        <td class="Table1" colspan="10">
                            <asp:Button ID="Button4" runat="server" CssClass="BtnLargeShort" Text="確定修改" />
                            &nbsp;
                            <asp:Button ID="Button6" runat="server" CssClass="BtnLargeShort" Text="刪除此紀錄" />
&nbsp;
                            <asp:Button ID="Button5" runat="server" CssClass="BtnLargeShort" Text="回復原值" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
