<%@ Page Language="C#" AutoEventWireup="true" CodeFile="採發1.aspx.cs" Inherits="採發1" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="Sht50" valign="top">
                                                ...
                                                <asp:Panel ID="Pnl_ItemPack" runat="server" Visible="False">
                                                    ...
                                                    <asp:Button ID="Button25" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" PostBackUrl="~/採發1_1.aspx" Text="存入分包工料" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
