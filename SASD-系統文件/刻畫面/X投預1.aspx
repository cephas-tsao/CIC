<%@ Page Language="C#" AutoEventWireup="true" CodeFile="X投預1.aspx.cs" Inherits="X投預1" %>
...
<body>
	...
	<table style="width: 100%">
		<tr>
			<td colspan="3" class="auto-style1">業主標單建置</td>
		</tr>
		<tr>
		<td class="auto-style15">請選擇標案</td>
		<td class="auto-style16" colspan="2">
		<asp:DropDownList id="DropDownList3" runat="server" Height="50px" Width="300px" Font-Size="Medium">
		</asp:DropDownList>
		...
		<tr>
			...
			<asp:RadioButtonList id="RadioButtonList1" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
				<asp:ListItem>逐項建置</asp:ListItem>
				<asp:ListItem>EXCEL(DIY)</asp:ListItem>
				<asp:ListItem>XML(PCCES)</asp:ListItem>
			</asp:RadioButtonList>
			</td>
			<td class="auto-style3" style="height: 45px">
						    <asp:Button ID="Button5" runat="server" Font-Names="微軟正黑體" Text="下載DIY格式檔案" Font-Size="Medium" Height="30px" Width="167px" />
			</td>
		</tr>
		<tr>
			...
			<asp:Panel id="Pnl_Build" runat="server" BorderColor="Maroon" BorderStyle="Solid" Visible="False">
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td class="auto-style4" colspan="2">
                                <asp:DropDownList ID="DropDownList4" runat="server" Font-Size="Medium" Height="30px" Width="155px">
                            ...
                            <td class="auto-style4" colspan="2">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style14">
                                            <asp:DropDownList ID="DropDownList29" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px">
                                                <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style14">
                                            <asp:DropDownList ID="DropDownList30" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px">
                                                <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                ...
                <asp:Panel ID="Pnl_WBS" runat="server" HorizontalAlign="Center" Visible="False">
                    <table class="Table1">
                        <tr>
                            <td class="auto-style69" colspan="8">WBS新增項目</td>
                        </tr>
                        <tr>
                            <td class="auto-style61">階層</td>
                            <td class="auto-style62">
                                <asp:DropDownList ID="DropDownList14" runat="server" Font-Size="Medium" Height="30px" Width="155px" AutoPostBack="True">
                                    <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                                    <asp:ListItem>3</asp:ListItem>
                            ...
                            <td class="auto-style62">
                                <asp:DropDownList ID="DropDownList16" runat="server" Font-Size="Medium" Height="30px" Width="155px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList16_SelectedIndexChanged">
                                    <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                    ...
                    <table class="Table1">
                        <tr>
                            ...
                            <td class="auto-style68">
                                <asp:DropDownList ID="DropDownList32" runat="server" AutoPostBack="True" Enabled="False" Font-Size="Medium" Height="30px" OnSelectedIndexChanged="DropDownList32_SelectedIndexChanged" Width="155px">
                                    <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                            ...
                            <td class="auto-style36">
                                <asp:TextBox ID="TextBox3" runat="server" Enabled="False" Font-Size="Medium" Height="25px" Width="800px"></asp:TextBox>
                            </td>
                    ...
                    <asp:Panel ID="Pnl_NewItem" runat="server" Visible="False">
                        <table class="Table2">
                            <tr>
                                ...
                                <td class="auto-style34">
                                    <asp:TextBox ID="TextBox21" runat="server" Font-Size="Medium" Height="25px" Width="150px"></asp:TextBox>
                                </td>
                    ...
                    <table class="Table3">
                        <tr>
                            <td>
                                <asp:Button ID="Button10" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="30px" Text="確定新增" Width="104px" />
			...
			<asp:Panel id="Pnl_ExcelDIY" runat="server" BorderColor="Maroon" BorderStyle="Solid" Visible="False">
				<table style="width: 100%">
					...
					<tr>
						...
						<asp:DropDownList id="DropDownList1" runat="server" Font-Size="Medium" Height="30px" Width="155px">
							<asp:ListItem Value="0">-請選擇-</asp:ListItem>
							<asp:ListItem>1</asp:ListItem>
							<asp:ListItem>2</asp:ListItem>
							<asp:ListItem>3</asp:ListItem>
					...
					<tr>
						...
						<asp:DropDownList id="DropDownList2" runat="server" Font-Size="Medium" Height="30px" Width="50px" Enabled="False">
							<asp:ListItem>.</asp:ListItem>
							<asp:ListItem>-</asp:ListItem>
							<asp:ListItem>,</asp:ListItem>
						</asp:DropDownList>
					...
					<tr>
						...
						<table style="width: 100%">
							<tr>
								<td class="auto-style13">第一階</td>
								<td class="auto-style14">
								<asp:DropDownList id="DropDownList10" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind">
									<asp:ListItem Value="0">-請選擇-</asp:ListItem>
								</asp:DropDownList>
							...
							<tr>
								<td class="auto-style13">第二階</td>
								<td class="auto-style14">
								    <asp:DropDownList ID="DropDownList25" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px">
                                        <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                    </asp:DropDownList>
								</td>
							</tr>
							<tr>
								<td class="auto-style13">第三階</td>
								<td class="auto-style14">
								    <asp:DropDownList ID="DropDownList26" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px">
                                        <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                    </asp:DropDownList>
								</td>
							</tr>
							<tr>
								...
								<td class="auto-style14">
								    <asp:DropDownList ID="DropDownList27" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="OrderName" DataValueField="Kind" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Width="148px">
                                        <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                    </asp:DropDownList>
								</td>
							</tr>
