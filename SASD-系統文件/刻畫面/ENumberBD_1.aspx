<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ENumberBD_1.aspx.cs" Inherits="ENumberBD_1" %>
    ...
    <div>
		...
		<td class="Table2C" colspan="9">
                                <table class="Sht100">
                                    ...
                                    <asp:ImageButton ID="ImageButton194" runat="server" Height="30px" ImageUrl="~/img/ArrowDOWN.jpg" ToolTip="下移" Width="27px" />
                                    ...
                                    <tr class="ShtRowSingle">
                                        <td class="ShtCellCC">
                                    <asp:ImageButton ID="ImageButton192" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="移除子項" Width="27px" />
                                    <asp:ImageButton ID="ImageButton193" runat="server" Height="30px" ImageUrl="~/img/ArrowUP.jpg" ToolTip="上移" Width="27px" />
                                            </td>
                                        <td class="ShtCellCC">
                                            <asp:TextBox ID="TextBox5" runat="server" CssClass="TBlong">結構用混凝土，預拌，175kgf/cm2，第1型水泥</asp:TextBox>
                                        </td>
                                        <td class="ShtCellCC">
        ...
        <tr>
			<td class="Table1">
                                    <asp:Button ID="Button5" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="53px" Text="確定拆分" PostBackUrl="~/ExeBudgetEdit_2.aspx" />
