<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeExeBudget.aspx.cs" Inherits="ChangeExeBudget" %>
...
<body>
    ...
    <div>
        ...
        <tr>
			<td class="auto-style1" colspan="6">執行預算變更</td>
		</tr>
        <tr>
			<td class="Table0" colspan="6">工項變更/數量追加減</td>
		</tr>
		<tr>
		<td class="auto-style2L" width="40%">
                                ...
                                &nbsp;
                                    <asp:ImageButton ID="IBtn_PriceFill" runat="server" Height="30px" ImageUrl="~/img/Price.jpg" ToolTip="前往單價填列" Width="27px" PostBackUrl="~/ChangeExeBudgetPEdit.aspx" />
                                &nbsp;
                                    <asp:ImageButton ID="IBtn_PriceFill0" runat="server" Height="30px" ImageUrl="~/img/Link.png" ToolTip="前往工項資源串聯" Width="27px" PostBackUrl="~/ChangeExeBudgetResourceLink.aspx" />
                                </td>
		...
		<td class="auto-style2">
            ...
            <td class="auto-style3">
                <asp:CheckBoxList ID="CheckBoxList2" runat="server" RepeatDirection="Horizontal">
                    ...
                    <asp:ListItem Selected="True">第2次變更</asp:ListItem>
                </asp:CheckBoxList>
            </td>
                        ...
                        <table border="1" class="Table1">
                            <tr class="TableTop">
                                ...
                                <td class="auto-style45" colspan="3">
                                    原執行預算</td>
                                <td class="auto-style45" colspan="3">
                                    <asp:HyperLink ID="HyperLink3" runat="server" Font-Underline="True" ForeColor="#0066FF" ToolTip="變更摘要編輯" NavigateUrl="~/EChangeSummaryE.aspx">第2次變更</asp:HyperLink>
                                </td>
