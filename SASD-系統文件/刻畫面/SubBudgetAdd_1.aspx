<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubBudgetAdd_1.aspx.cs" Inherits="SubBudgetAdd_1" %>
                                                ...
                                                <asp:Panel ID="Pnl_Source" runat="server" Visible="False">
                                                    ...
                                                    <table class="SB_Table_A">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="SB_Cell1R_A">272</td>
                                                            <td class="SB_Cell1C_A">
                                                                <asp:TextBox ID="TextBox18" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="100px">272</asp:TextBox>
                                                            </td>
                                                            <tr>
                                                                <td class="SB_Cell1C_A">
                                                                ...
                                                                <td class="SB_Cell1R_A">1,008</td>
                                                                <td class="SB_Cell1C_A">
                                                                    <asp:TextBox ID="TextBox21" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="100px">1008</asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </tr>
                                                        </tr>
                                                    ...
                                                    <asp:Button ID="Button23" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="存入分包工料" PostBackUrl="~/SubBudgetAdd_2.aspx" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
