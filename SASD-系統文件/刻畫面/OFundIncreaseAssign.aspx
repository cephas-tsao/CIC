<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OFundIncreaseAssign.aspx.cs" Inherits="OFundIncreaseAssign" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <table class="Table100">
            <tr>
                <td class="TableTop" colspan="9">請款單指定加款明細</td>
            </tr>
            <tr>
                <td class="Table1">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="Table2CC">2015/06/25</td>
                <td class="Table2RC">30,000.00</td>
                <td class="Table2RC">1,500.00</td>
                <td class="Table2RC">31,500.00</td>
                <td class="Table2RC">台科工款字第104060178號</td>
                <td class="Table2CC">王大遠</td>
            </tr>
            <tr>
                <td class="Table2CC">
                ...
                <td class="Table2RC">1,500.00</td>
                <td class="Table2RC">31,500.00</td>
                <td class="Table2RC">台科工款字第104080273號</td>
                <td class="Table2CC">王大遠</td>
            </tr>
            <tr>
