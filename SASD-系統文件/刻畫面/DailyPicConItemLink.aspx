<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyPicConItemLink.aspx.cs" Inherits="DailyPicConItemLink" %>
...
<body>
    ...
    <div>
        ...
        <table class="Table100">
            <tr>
                <td class="TableTop">施工照片連結合約項目選擇</td>
                <td class="TableTop" width="20%">
                    <asp:Button ID="Button1" runat="server" CssClass="BtnFree" Text="關閉視窗" />
                </td>
            </tr>
        </table>
        ...
        <table border="1" class="Sht100">
                            <tr class="ShtRowTop">
                                <td rowspan="2" class="ShtCellCC">&nbsp;</td>
                                ...
                                <td rowspan="2" class="ShtCellCC">單價<br />
                                    分析</td>
                                <td colspan="3" class="ShtCellCC">原合約預算</td>
                                <td colspan="3" class="ShtCellCC">
                                    末次變更設計後</td>
                                <td rowspan="2" class="ShtCellCC">備註</td>
                            </tr>
                            <tr class="ShtRowTop">
                            ...
                            <tr class="ShtRowSingle">
                                <td align="center" class="ShtCellCC">
                                    <asp:Button ID="Button4" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                            ...
                            <tr class="ShtRowDouble">
                                <td class="ShtCellCC">
                                    <asp:Button ID="Button5" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC"></td>
                                <td colspan="2"  align="center" class="ShtCellCC">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button2" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                            ...
                            <tr class="ShtRowDouble">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button3" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button6" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                            ...
                            <tr class="ShtRowDouble">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button7" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button8" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowDouble">
                                <td class="ShtCellCC">
                                    <asp:Button ID="Button9" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC"></td>
                                <td class="ShtCellCC"></td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button10" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowDouble">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button11" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button12" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                            ...
                            <tr class="ShtRowDouble">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button13" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button14" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowDouble">
                                <td class="ShtCellCC">
                                    <asp:Button ID="Button15" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC"></td>
                                <td class="ShtCellCC"></td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button16" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowDouble">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button17" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
                            ...
                            <tr class="ShtRowSingle">
                                <td style="width: 3px" class="ShtCellCC">
                                    <asp:Button ID="Button18" runat="server" CssClass="BtnFree" Text="選擇" />
                                </td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC">&nbsp;</td>
                                <td class="ShtCellCC" align="center">
