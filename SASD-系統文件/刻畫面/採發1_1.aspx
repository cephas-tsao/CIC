<%@ Page Language="C#" AutoEventWireup="true" CodeFile="採發1_1.aspx.cs" Inherits="採發1_1" %>
		...
		<td class="auto-style3">
                                    <table class="SB_Table_M">
                                        ...
                                        <tr class="SB_Row_M">
                                            ...
                                            <td class="ShtCellCR">xxx,xxx.xx</td>
                                        </tr>
                                    </table>
                                                    </td>
		</tr>
                                                ...
                                                <asp:Panel ID="Pnl_Analysis" runat="server" Visible="False">
                                                    ...
                                                    <table class="SB_Table_A">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="SB_Cell1R_A">
                                                                168.000</td>
                                                            <td class="SB_Cell1R_A">168.000</td>
                                                            <td class="SB_Cell1C_A">
                                                    ...
                                                    <asp:Button ID="Button19" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="存入分包工料" PostBackUrl="~/採發1_2.aspx" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
