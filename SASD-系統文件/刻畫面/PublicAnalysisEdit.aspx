<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicAnalysisEdit.aspx.cs" Inherits="PublicAnalysisEdit" %>
...
<body>
    ...
    <div>
                    ...
                    &nbsp;&nbsp;&nbsp; &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">自共用工料資料庫代入</asp:LinkButton>
                                        </td>
                                </tr>
                                    <tr>
                                    <td class="auto-style34A">
                                        <asp:Panel ID="Pnl_Import" runat="server" Visible="False">
                                            <table class="Table3">
                                                <tr>
                                                    <td class="auto-style75">共用工料資料庫</td>
                                                </tr>
                                                <tr>
