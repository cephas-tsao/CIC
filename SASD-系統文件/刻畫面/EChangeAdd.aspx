<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EChangeAdd.aspx.cs" Inherits="EChangeAdd" %>
...
<body>
    ...
    <table class="Table100">
        <tr>
			<td class="TableTop">執行預算變更-新增工項</td>
		</tr>
		</table>
            ...
            <table style="width: 100%">
                <tr>
                    <td class="Table0" width="25%">
                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" ForeColor="White">合約預算變更新增工項列表</asp:LinkButton>
                    </td>
                </tr>
            </table>
            <asp:Panel ID="Pnl_CAdd" runat="server" Visible="False">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <table class="Table100">
                        <tr>
                            <td class="Table0" colspan="8">新增執行預算工項</td>
                        </tr>
                        <tr>
                    ...
                    <asp:Label ID="Label173" runat="server" Font-Bold="True" Font-Names="微軟正黑體" ForeColor="Red" Format="{0:N4}" Text="3"></asp:Label>
                        ...
                        <tr>
                            <td class="Table1" colspan="8">
                                    <asp:Button ID="Button5" runat="server" Text="確定新增並離開" PostBackUrl="~/執預3_2.aspx" CssClass="BtnLargeMedium" />
                                &nbsp;
                                    <asp:Button ID="Button4" runat="server" Text="返回前頁" PostBackUrl="~/執預2.aspx" CssClass="BtnLargeMedium" />
                                </td>
                        </tr>
                    </table>
    </div>
