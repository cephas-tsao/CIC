<%@ Page Language="C#" AutoEventWireup="true" CodeFile="採發1_2.aspx.cs" Inherits="採發1_2" %>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                ...
                                                <asp:Panel ID="Pnl_SourcePack" runat="server" Visible="False">
                                                    ...
                                                    <asp:Button ID="Button27" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="全資源存入分包工料" PostBackUrl="~/採發1_3.aspx" />
                                                </asp:Panel>
