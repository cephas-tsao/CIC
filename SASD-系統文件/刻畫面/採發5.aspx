<%@ Page Language="C#" AutoEventWireup="true" CodeFile="採發5.aspx.cs" Inherits="採發5" %>
            ...
            <asp:Panel ID="Pnl_Price" runat="server" Visible="False">
                <table style="width: 100%; font: 微軟正黑體 normal normal 100% serif;">
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:Label ID="Label686" runat="server" Text="35,000"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="Red" Text="38,000"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td class="auto-style106">100.000</td>
                        <td class="auto-style106">50.000</td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style106">100.000</td>
                        <td class="auto-style106">200.000</td>
                        <td class="auto-style106">-</td>
                        <td class="auto-style106">-</td>
                        <td class="auto-style106">&nbsp;</td>
                        <td class="auto-style106">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style106">100.000</td>
                        <td class="auto-style106">67.500</td>
                        <td class="auto-style106">-</td>
                        <td class="auto-style106">-</td>
                        <td class="auto-style106">&nbsp;</td>
                        <td class="auto-style106">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style109">100.000</td>
                        <td class="auto-style109">50.000</td>
