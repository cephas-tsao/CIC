...
<form id="form1" runat="server">
	...
	<table style="width: 55%; height: 325px" class="auto-style10">
		...
		<asp:TextBox id="TextBox8" runat="server" Height="100px" Width="600px" BackColor="White" BorderColor="White" ReadOnly="True"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="auto-style2" style="height: 50px; width: 200px">變更設計</td>
			<td class="auto-style8" style="width: 600px; height: 50px" valign="top">
		<asp:TextBox id="TextBox9" runat="server" Height="100px" Width="600px" BackColor="White" BorderColor="White" ReadOnly="True"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="auto-style2" style="height: 50px; width: 200px">爭議處理</td>
			<td class="auto-style8" style="width: 600px; height: 50px" valign="top">
		<asp:TextBox id="TextBox10" runat="server" Height="100px" Width="600px" BackColor="White" BorderColor="White" ReadOnly="True"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td class="auto-style2" style="height: 50px; width: 200px">其他</td>
			<td class="auto-style8" style="width: 600px; height: 50px" valign="top">
		<asp:TextBox id="TextBox11" runat="server" Height="100px" Width="600px" BackColor="White" BorderColor="White" ReadOnly="True"></asp:TextBox>
			</td>
		</tr>
		</table>
</form>
