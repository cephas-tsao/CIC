<%@ Page Language="C#" AutoEventWireup="true" CodeFile="採發8.aspx.cs" Inherits="採發8" %>
                        ...
                        <asp:Panel ID="Pnl_InviteQ" runat="server" Visible="False">
                            ...
                            <asp:Panel ID="Pnl_Detail" runat="server" Visible="False">
                                ...
                                <table class="auto-style4">
                                    ...
                                    <tr>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label701" runat="server" Font-Size="Medium" Height="25px">產品，鋼筋，SD280</asp:Label>
                                        </td>
                                        <td class="auto-style103">
                                            <asp:Label ID="Label702" runat="server" Font-Size="Medium" Height="25px" Width="50px">T</asp:Label>
                                        </td>
                                        <td class="auto-style105">
                                    ...
                                    <tr>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label704" runat="server" Font-Size="Medium" Height="25px">產品，金屬材料，鐵線</asp:Label>
                                        </td>
                                        <td class="auto-style103">
                                            <asp:Label ID="Label705" runat="server" Font-Size="Medium" Height="25px" Width="50px">KG</asp:Label>
                                        </td>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label706" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="壹.二.4.2.1F-鋼筋"></asp:Label>
                                        </td>
                                        <td class="auto-style106">2.000</td>
                                        <td class="auto-style106">-</td>
                                        <td class="auto-style106">-</td>
                                    ...
                                    <tr>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label707" runat="server" Font-Size="Medium" Height="25px">技術工</asp:Label>
                                        </td>
                                        <td class="auto-style103">
                                            <asp:Label ID="Label708" runat="server" Font-Size="Medium" Height="25px" Width="50px">工</asp:Label>
                                        </td>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label709" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="壹.二.4.2.1F-鋼筋"></asp:Label>
                                        </td>
                                        <td class="auto-style106">0.675</td>
                                        <td class="auto-style106">-</td>
                                        <td class="auto-style106">-</td>
                                    ...
                                    <tr>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label710" runat="server" Font-Size="Medium" Height="25px">小工</asp:Label>
                                        </td>
                                        <td class="auto-style103">
                                            <asp:Label ID="Label711" runat="server" Font-Size="Medium" Height="25px" Width="50px">工</asp:Label>
                                        </td>
                                        <td class="auto-style105">
                                            <asp:Label ID="Label712" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="壹.二.4.2.1F-鋼筋"></asp:Label>
                                        </td>
                                        <td class="auto-style106">0.675</td>
                                        <td class="auto-style106">-</td>
                                        <td class="auto-style106">-</td>
                                    ...
                                    <tr>
                                        <td class="auto-style107">
                                            <asp:Label ID="Label713" runat="server" Font-Size="Medium" Height="25px">零星工料，約以上項目之3.0%</asp:Label>
                                        </td>
                                        <td class="auto-style108">
                                            <asp:Label ID="Label714" runat="server" Font-Size="Medium" Height="25px" Width="50px">式</asp:Label>
                                        </td>
                                        <td class="auto-style107">
                                            <asp:Label ID="Label715" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="壹.二.4.2.1F-鋼筋"></asp:Label>
                                        </td>
                                        <td class="auto-style109">0.500</td>
