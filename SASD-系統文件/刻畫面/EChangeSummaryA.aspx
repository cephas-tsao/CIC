<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EChangeSummaryA.aspx.cs" Inherits="EChangeSummaryA" %>
...
<body>
    ...
    <div>
        ...
        <tr>
			<td class="auto-style1" colspan="4">執行預算變更-新增變更摘要</td>
		</tr>
		<tr>
		...
		<td class="auto-style2" colspan="4">
                                    <asp:Button ID="Button5" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="53px" Text="新增變更並離開" PostBackUrl="~/執預3_1.aspx" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
