<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivitySetting_1.aspx.cs" Inherits="ActivitySetting_1" %>
...
<body>
    ...
    <table class="Table100">
		...
		<td class="Table1L">
                                ...
                                &nbsp; <asp:Image ID="IBtn_Lock" runat="server" Height="30px" Width="27px" TabIndex="0" />
                                </td>
		<td class="Table1R">
                        ...
                        <table id="ActivityTable" border="1" class="Sht100">
                            ...
                            <tr class="ShtRowDouble">
                                <td class="ShtCellCC">
                                    <asp:ImageButton ID="IBtn_A2" runat="server" Height="30px" ImageUrl="~/img/AddNewItem.png" ToolTip="新增作業項目" Width="27px" PostBackUrl="~/EReallocation.aspx" />
                                    <asp:ImageButton ID="IBtn_D2" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除作業項目" Width="27px" />
                                </td>
                                <td class="ShtCellCC">
                                    2</td>
                                <td class="ShtCellCL">
                                ...
                                <td class="ShtCellCC">
                                    <asp:TextBox ID="TB_N2" runat="server" CssClass="TBlong"></asp:TextBox>
                                </td>
                                <td class="ShtCellCC">
                                    <asp:TextBox ID="TB_P2" runat="server" CssClass="TBshort" style="text-align:center" Text="100"></asp:TextBox>
                                    ％</td>
                            </tr>
                            <tr class="ShtRowSingle">
                                <td class="ShtCellCC">
                            ...
                            <tr class="ShtRowSingle">
                                <td class="ShtCellCC">
                                    <asp:ImageButton ID="IBtn_A9" runat="server" Height="30px" ImageUrl="~/img/AddNewItem.png" ToolTip="新增作業項目" Width="27px" />
                            ...
                            <tr class="ShtRowDouble">
                                ...
                                <td class="ShtCellCC">
                                    5.3</td>
                                <td class="ShtCellCL">
                                    <asp:Label ID="Label269" runat="server" Height="25px" Text="2F-普通模板" Font-Names="微軟正黑體"></asp:Label>
                                </td>
                                <td class="ShtCellCC">
                                    <asp:TextBox ID="TB_N10" runat="server" CssClass="TBlong"></asp:TextBox>
                                </td>
                                <td class="ShtCellCC">
                                    <asp:TextBox ID="TB_P10" runat="server" CssClass="TBshort" style="text-align:center"></asp:TextBox>
                                    ％</td>
                            </tr>
                            <tr class="ShtRowSingle">
                                <td class="ShtCellCC">
                                ...
                                <td class="ShtCellCC">
                                    <asp:TextBox ID="TB_P11" runat="server" CssClass="TBshort" style="text-align:center" Text="100"></asp:TextBox>
                                    ％</td>
                            </tr>
                            </table>
    </div>
