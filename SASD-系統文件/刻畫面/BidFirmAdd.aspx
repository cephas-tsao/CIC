	...
	<table class="auto-style5" style="width: 100%">
		...
		<tr>
			<td class="auto-style7" style="height: 45px;" colspan="4">
                <asp:Button id="Button3" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="確定新增" Width="100px" />
		&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button id="Button4" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="全部清空" Width="100px" />
			    </td>
