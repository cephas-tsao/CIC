<%@ Page Language="C#" AutoEventWireup="true" CodeFile="計價3.aspx.cs" Inherits="計價3" %>
            ...
            <table class="Table100">
                ...
                <tr>
                    ...
                    <td class="Table2">
                        ...
                        <asp:Button ID="Button5" runat="server" CssClass="BtnFree" Height="30px" OnClick="Button5_Click" Text="自動合計" />
                    </td>
                </tr>
                <tr>
                            ...
                            <table class="Table100">
                                ...
                                <tr>
                                    ...
                                    <td class="Table2">
                                        <asp:DropDownList ID="DDL_Style0" runat="server" CssClass="DDLshort">
                                            ...
                                            <asp:ListItem>代雇工扣款</asp:ListItem>
                                            <asp:ListItem>扣其他款項</asp:ListItem>
                                            <asp:ListItem Selected="True">罰款</asp:ListItem>
                                            <asp:ListItem>應減金額</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="Table2">
                                        ...
                                        <asp:Button ID="Button6" runat="server" CssClass="BtnFree" Height="32px" OnClick="Button6_Click" Text="5%自動計算" />
                                    </td>
                                    <td class="Table1">扣款總額</td>
                                    <td class="Table2">
