<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExeBudgetEdit.aspx.cs" Inherits="ExeBudgetEdit" %>
...
<body>
    ...
    <div>
		...
		<td class="auto-style2L">
                                ...
                                &nbsp;
                                    <asp:ImageButton ID="IBtn_PriceFill0" runat="server" Height="30px" ImageUrl="~/img/Link.png" ToolTip="前往工項資源串聯" Width="27px" PostBackUrl="~/ExeBudgetResourceLink.aspx" />
                                &nbsp; <asp:ImageButton ID="IBtn_Reload" runat="server" Height="30px" ImageUrl="~/img/Caution.png" ToolTip="重新匯入合約預算" Width="27px" />
            ...
            <td class="auto-style2">
                        ...
                        <table id="EBudget" border="1" class="Table1">
                            ...
                            <tr class="TableSingle">
                                ...
                                <td class="auto-style83">式</td>
                                <td class="auto-style83">&nbsp;</td>
                                <td class="auto-style83">&nbsp;</td>
                                <td class="auto-style83">&nbsp;</td>
                                <td class="auto-style83">1</td>
                                <td class="auto-style83">xxxxxxxx</td>
                                <td class="auto-style83">xxxxxxxx</td>
                            ...
                            <tr class="TableSingle">
                                ...
                                <td class="autoRight">式</td>
                                <td class="autoRight">&nbsp;</td>
                                <td class="autoRight">&nbsp;</td>
                                <td class="autoRight">&nbsp;</td>
                                <td class="autoRight">1</td>
                                <td class="autoRight">xxxxxx</td>
                                <td class="autoRight">xxxxxx</td>
                                <td class="autoRight">
                            ...
                            <tr class="TableSingle">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton145" runat="server" Height="30px" ImageUrl="~/img/Reallocation.png" ToolTip="拆工料" Width="27px" PostBackUrl="~/EReallocation.aspx" />
                                </td>
                                <td class="auto-style106">&nbsp;</td>
                                <td class="auto-style55">&nbsp;</td>
                            ...
                            <tr class="TableDouble">
                                <td class="auto-style104">
                                    <asp:ImageButton ID="ImageButton184" runat="server" Height="30px" ImageUrl="~/img/NumBD.png" ToolTip="拆數量" Width="27px" />
                                </td>
                                ...
                                <td class="autoRight">
                                    <asp:TextBox ID="TextBox18" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="50px" Enabled="False">65.5</asp:TextBox>
                                </td>
                                <td class="autoRight">
                            ...
                            <tr class="TableExecute">
                                ...
                                <td class="autoRight">
                                    95,100</td>
                                <td class="autoRight">
                                    <asp:TextBox ID="TextBox65" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="150px"></asp:TextBox>
                                </td>
                                <td class="autoRight">
