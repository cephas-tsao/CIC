<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubBudgetAdd_2.aspx.cs" Inherits="SubBudgetAdd_2" %>
		...
		<td class="auto-style3">
                                    <table class="SB_Table_M">
                                        ...
                                        <tr class="SB_Row_M">
                                            ...
                                            <td class="ShtCellCR">1,974,400</td>
                                        </tr>
                                    </table>
                                                    </td>
		</tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" valign="top">
                                                <asp:Panel ID="Pnl_Source" runat="server" Visible="False">
                                                    ...
                                                    <asp:Button ID="Button23" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="存入分包工料" PostBackUrl="~/SubBudgetAdd_3.aspx" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
