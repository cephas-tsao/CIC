<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubChangeAddMaterial.aspx.cs" Inherits="AddSubBudgetMaterial" %>
                                            ...
                                            <td class="Sht50" valign="top">
                                                <table class="Sht100">
                                                    ...
                                                    <tr class="ShtRowSingle">
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox91" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton73" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox92" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton172" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        ...
                                                        <td class="auto-style1">
                                                            <asp:TextBox ID="TextBox93" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="auto-style1">
                                                            <asp:ImageButton ID="ImageButton173" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox94" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton176" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox95" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton255" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox96" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton256" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox97" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton257" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox98" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton258" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox99" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton222" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox100" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton251" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" PostBackUrl="~/SubBudgetAdd_1.aspx" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox101" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton252" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox102" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton253" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox103" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton254" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox104" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton223" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox105" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton247" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox106" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton248" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox107" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton224" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox108" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton249" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox109" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton250" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox110" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton178" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox111" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton244" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox112" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton245" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox113" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton246" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox114" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton179" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC"></td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox115" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton180" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox116" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton239" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox117" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton240" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox118" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton241" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox119" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton242" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox120" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton243" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox121" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton238" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox122" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton237" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox123" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton236" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox124" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton235" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox125" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton234" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox126" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton233" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox127" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton232" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox128" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton181" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox129" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton182" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox130" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton183" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox131" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton231" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox132" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton185" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox133" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton230" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox134" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton229" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox135" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton228" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox136" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton186" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox137" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton227" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox138" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton187" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox139" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton226" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowExecuteSoft">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox140" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton225" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox141" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton188" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox142" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton189" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowSingle">
                                                        <td class="ShtCellCC">&nbsp;</td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox143" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton190" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                    <tr class="ShtRowDouble">
                                                        <td class="ShtCellCC"></td>
                                                        ...
                                                        <td class="ShtCellCC">
                                                            <asp:TextBox ID="TextBox144" runat="server" CssClass="TBshort"></asp:TextBox>
                                                        </td>
                                                        <td class="ShtCellCC">
                                                            <asp:ImageButton ID="ImageButton191" runat="server" Height="30px" ImageUrl="~/img/ArrowLeft.jpg" ToolTip="加入至本次追加減" Width="30px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <asp:Panel ID="Pnl_Source" runat="server" Visible="False">
                                                    <table class="SB_Table_A">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="SB_Cell1R_A">1,480</td>
                                                            <td class="SB_Cell0C_A">分包單價</td>
                                                            <td class="SB_Cell1C_A">
                                                                <asp:TextBox ID="TextBox145" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="100px"></asp:TextBox>
                                                            </td>
                                                            <td class="SB_Cell0C_A" colspan="4">
                                                    ...
                                                    <asp:Button ID="Button23" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="增加至本次追加減" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
