<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BidOutputSetting.aspx.cs" Inherits="BidOutputSetting" %>
...
<body>
	...
	<table style="width: 100%">
		...
		<td class="auto-style15">
		    檔案名稱</td>
		<td class="auto-style16">
		    <asp:TextBox ID="TextBox104" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="300px"></asp:TextBox>
                                </td>
		</tr>
		<tr>
		...
		<td class="auto-style17">
		    機關/公司名稱</td>
		<td class="auto-style16">
                                    <asp:TextBox ID="TextBox102" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="300px"></asp:TextBox>
            </td>
		<td class="auto-style15">
		    預算表尾</td>
		<td class="auto-style16">
		...
		<td class="auto-style16">
            ...
            <asp:TextBox ID="TextBox105" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="120px"></asp:TextBox>
            </td>
		<td class="auto-style16">
		...
		<td class="auto-style16">
		    使用字型：<asp:DropDownList ID="DropDownList1" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px">
                <asp:ListItem Selected="True">新細明體</asp:ListItem>
                <asp:ListItem>標楷體</asp:ListItem>
            </asp:DropDownList>
                                </td>
		</tr>
		</table>
		...
		<td class="auto-style15" colspan="4">
                                <asp:Button ID="Button16" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="匯出EXCEL檔" Width="150px" />
                            </td>
		</tr>
		</table>
