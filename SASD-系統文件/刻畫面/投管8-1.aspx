...
<form id="form1" runat="server">
	...
	<table class="auto-style5" style="width: 85%">
		...
		<tr>
			<td class="auto-style2" colspan="5" style="height: 29px">投標評估(初評)</td>
		</tr>
		<tr>
    ...
    <table class="auto-style5" style="width: 85%">
		...
		<asp:Button id="Button3" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="條件評估" Width="145px" />
			...
			<td class="auto-style71">
		<asp:Button id="Button4" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="合約條款評估" Width="145px" />
    ...
    <table class="auto-style5" style="width: 85%">
		<tr>
			...
			<td class="auto-style72">
		        <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem>擬積極參與競標</asp:ListItem>
                    <asp:ListItem>可嘗試競標</asp:ListItem>
                    <asp:ListItem>條件太差不擬參與</asp:ListItem>
                </asp:RadioButtonList>
            </td>
		</tr>
		<tr>
		...
		<asp:Button id="Button5" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="結果暫存" Width="145px" />
		        &nbsp;&nbsp;&nbsp;&nbsp;
