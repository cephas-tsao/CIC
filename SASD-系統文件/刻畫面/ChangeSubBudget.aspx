<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeSubBudget.aspx.cs" Inherits="ChangeSubBudget" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td class="Table0">&nbsp;&nbsp;&nbsp;
                                    <asp:LinkButton ID="LinkButton36" runat="server" OnClick="LinkButton36_Click" ForeColor="White">分包合約工項</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td class="Table1L" colspan="3">&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton176" runat="server" Height="30px" ImageUrl="~/img/AddNewList.png" PostBackUrl="~/EChangeSummaryA.aspx" ToolTip="新增執行預算變更" Width="27px" />
                                        &nbsp;
                                        <asp:ImageButton ID="ImageButton207" runat="server" BorderStyle="None" Height="30px" ImageUrl="~/img/AddNewItem.png" PostBackUrl="~/SubChangeAddMaterial.aspx" ToolTip="增加新工項" Width="27px" />
                                    </td>
                                </tr>
                                <tr>
