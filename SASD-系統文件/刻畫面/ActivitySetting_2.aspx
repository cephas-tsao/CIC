<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivitySetting_2.aspx.cs" Inherits="ActivitySetting_2" %>
...
<body>
    ...
    <table class="Table100">
		...
		<td class="Table1R">
                                    ...
                                    <asp:ImageButton ID="IBtn_AddNew" runat="server" Height="30px" ImageUrl="~/img/AddNewItem.png" ToolTip="儲存" Width="27px" PostBackUrl="~/ActivitySetting_3.aspx" />
                                </td>
		</tr>
		</table>
