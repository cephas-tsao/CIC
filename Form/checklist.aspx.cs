...
public partial class test : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String cplaceid;
        Application.Lock();
        cplaceid = Application["cplaceid"].ToString();
        Application.UnLock();
        ...
        String select1 = "select * from items where projectid ='" + Label2.Text + "' and phasee='施工前'";  //宣告SQL語法的字串，這邊可依照自行需求修改
        ...
        while (reader.Read())   //使用無限迴圈將SQL語法查詢的結果每筆查閱一次
        {
            ...
            //for(i=0;i<=reader.FieldCount-1;i++){
                ...
                radioList.Items.Add(new ListItem("合格", "1"));
                radioList.Items.Add(new ListItem("不合格", "2"));
                radioList.Items.Add(new ListItem("未檢查", "3"));
        ...
        String select3 = "select * from items where projectid ='" + Label2.Text + "' and phasee='施工中'";  //宣告SQL語法的字串，這邊可依照自行需求修改
        ...
        String select4 = "select * from items where projectid ='" + Label2.Text + "' and phasee='施工後'";  //宣告SQL語法的字串，這邊可依照自行需求修改
        ...
        while (reader.Read())   //使用無限迴圈將SQL語法查詢的結果每筆查閱一次
        {
            ...
            radioList.Items.Add(new ListItem("合格", "合格"));
            radioList.Items.Add(new ListItem("不合格", "不合格"));
            radioList.Items.Add(new ListItem("未檢查", "未檢查"));
