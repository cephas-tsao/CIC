<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BidFirmAdd.aspx.cs" Inherits="IMS.BidFirmAdd" %>
	...
	<table class="auto-style5" style="width: 100%">
		...
		<tr>
			<td class="Table1" style="height: 45px;" colspan="4">
                <asp:Button id="Save" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="確定新增" Width="100px" OnClick="SaveAction" />
		&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button id="Clear" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="全部清空" Width="100px" OnClick="Clear_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button id="Btnclose" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="35px" Text="關閉" Width="100px" OnClientClick="window.close()" />
			    </td>
