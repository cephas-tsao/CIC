<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FFundDebitView.aspx.cs" Inherits="IMS.FFundDebitView" %>
...
<body>
    ...
    <div>
       <table class="Table100">
            <tr>
                <td class="TableTop">分包商計價扣款明細檢視</td>
            </tr >
        </table >
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                ...
                <SortedDescendingHeaderStyle BackColor="#4870BE" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="Select * From FFund_Modify Where BelongFFID=@FFID And IncreaseDebit='D'">
                            <SelectParameters>
