                ...
                if (vsDt.Rows.Count > 0)
                {
                    for (int i = 0; i < vsDt.Rows.Count; i++)
                    {
                        ...
                        if (change != "")
                        {
                            if (layer == "1")
                            {
                                ListStr2 = @"<tr style=""background-color:white"" class=""treegrid-{14}"" id=""{14}""> <td>";

                            }
                            else
                            {
                                ListStr2 = @"<tr style=""background-color:white"" class=""treegrid-{14} treegrid-parent-{15}"" id=""{14}""> <td>";

                            }
                            ListStr2 += @"
                                 <a href=""javascript:void(0)"" {13} onclick=""window.open('EChangeDetail.aspx?EWID={12}','subwin','width=1500,height=500');"" > <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""25px""  style=""visibility:{11};Float:right""  /></a>";
                        ...
                        else
                        {
                            ...
                            if (layer == "1")
                            {
                                ListStr2 += @"<tr style=""background-color:white"" class=""treegrid-{14}"" id=""{14}"">  <td style=""width: 8px"">";

                            }
                            else
                            {
                                ListStr2 += @"<tr style=""background-color:white"" class=""treegrid-{14} treegrid-parent-{15}"" id=""{14}"">  <td style=""width: 8px"">";

                            }

                            //ListStr2 += @"<tr class=""TableSingle""> <td style=""width: 8px"">";
                        ...
                        tmpStr3.AppendLine(string.Format(ListStr2, LbWid, LbPriceID, Orderlayer, order, LbItemName, LbUnit, LbCNumber, LbEPrice, LbCComplex, ChAmount, LbNotes, Link, Link1, Link2, order_Num, Find_order_Num));
                        ...
                        if (vsDt1.Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < vsDt1.Rows.Count; i++)
                            {
                                ...
                                if (layer == "1")
                                {
                                    ...
                                    tmpStr2.AppendLine("<tr style=\"background-color:white\" id=" + order_Num + " class=\"treegrid-" + order_Num + "\"> <td class=\"auto-style80\">");
                                }
                                else
                                {
                                    tmpStr2.AppendLine("<tr style=\"background-color:white\" id=" + order_Num + " class=\"treegrid-" + order_Num + " treegrid-parent-" + Find_order_Num + "\"> <td class=\"auto-style80\">");

                                }
                                //tmpStr2.AppendLine("<tr class=\"TableSingle\"> <td class=\"auto-style80\">");

                                //tmpStr2.AppendLine("<tr class=\"ShtRowSingle\"> <td class=\"auto-style80\">");

                                if (change != "")
                                {
                                    tmpStr2.AppendLine(" <a href=\"javascript: void(0);\" " + Link1 + " onclick=\"window.open('EChangeDetail.aspx?EWID=" + Link + "','subwin','width=1500,height=500');\" ><img src=\"../img/Edit.png\" ToolTip=\"逐項編輯\" Width=\"25px\"  style=\"visibility:" + Img2 + ";Float:right \"></a>");
