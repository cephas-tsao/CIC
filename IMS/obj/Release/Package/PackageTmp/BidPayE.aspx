<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BidPayE.aspx.cs" Inherits="IMS.BidPayE" %>
...
<script type="text/javascript">
    ...
    //function lon() {
    //    var lon = document.getElementById("PrepayPercentage").value.length;
    //    if (lon >= 5) {
    //        alert("超過長度");
    //        return false;
    //    }
...
<form id="form1" runat="server">
	<br />
	<table style="width: 1000px; height: 150px" class="auto-style12">
		<tr>
			<td class="TableTop" colspan="4"><span >
			<strong>業主付款方式編修</strong></span></td>
		</tr>
		<tr>
			<td class="Table1" style="width: 210px">預付款百分比</td>
			<td style="width: 190px" class="Table2">
		<asp:TextBox id="PrepayPercentage" runat="server" Height="30px" Width="125px" onkeyup="return ValidateFloat2(this,value);"></asp:TextBox>
		...
		<asp:TextBox id="OtherPayment" runat="server" Height="100px" Width="780px" TextMode="MultiLine"></asp:TextBox>
			</td>
		</tr>
		<tr>
