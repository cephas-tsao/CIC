<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CChangeSummaryV.aspx.cs" Inherits="IMS.CChangeSummaryV" %>
...
<body>
   ...
   <asp:sqldatasource ID="Sqldatasource1" runat="server"></asp:sqldatasource> 
		...
		<td class="auto-style2">
                                總追加減金額</td>
            <td class="auto-style3">
                                    <asp:Label ID="LbIdMoney" runat="server" Text="+2257013"></asp:Label>
            </td>
            <td class="auto-style2">
                變更後合約總價</td>
            <td class="auto-style3">
