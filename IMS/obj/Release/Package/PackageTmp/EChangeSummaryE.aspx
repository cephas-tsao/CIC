<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EChangeSummaryE.aspx.cs" Inherits="IMS.EChangeSummaryE" %>
...
<body>
    ...
    <div>
		...
		<td class="auto-style2">
                                總追加減金額</td>
            <td class="auto-style3">
                                    <asp:Label ID="LbIdMoney" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="150px" ></asp:Label>
            </td>
            <td class="auto-style2">
                變更後合約總價</td>
            <td class="auto-style3">
		...
		<td class="auto-style2" colspan="4">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="Button4" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="53px" Text="返回前頁"  OnClick="BtnBack_Click" />
                                </td>
		</tr>
		</table>
