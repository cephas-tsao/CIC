<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CBudgetLayerSet.aspx.cs" Inherits="IMS.CBudgetLaterSet" %>
...
<body>
    ...
    <div>
        ...
        <table class="Table100">
            <tr>
                <td class="TableTop" colspan="4">合約預算-編號及階層設定</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="Table2R" colspan="2">
                            ...
                            <br />
                       <asp:Button ID="BtnDelayer" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="-階層" Width="100px" OnClick="BtnDelayer_Click" /> <asp:LinkButton ID="Button3" runat="server" OnClick="Button3_Click"></asp:LinkButton>
       ...
       <%--     <tr>             
                             <td class="Table1" colspan="4">
                                <asp:Button ID="Button2" runat="server" Font-Bold="False" Font-Names="微軟正黑體" Font-Size="Medium" Height="30px" Text="+階層" Width="100px" OnClick="AddLayer_Click" />
