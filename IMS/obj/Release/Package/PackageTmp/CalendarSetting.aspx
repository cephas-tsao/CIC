...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <Area:MemberBoxUC ID="MemberBox" runat="server" /> 
    ...
    <div style="width:20%;float:left"><asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" 
        ForeColor="Black"  NextPrevFormat="ShortMonth" OnSelectionChanged="Calendar1_SelectionChanged" Width="300px" SelectionMode="Day"  >
  ...
  <%--  <div id="div1"></div>--%>
    ...
    <table style="width:80%;margin-left:5%"  >
        <tr><td class="Table1">選擇專案</td><td  colspan="4"> <asp:DropDownList ID="Ddl_Project" runat="server" AutoPostBack="True" CssClass="DDLfree" DataSourceID="SqlDataSource1" DataTextField="CodeName" DataValueField="PID" OnSelectedIndexChanged="Ddl_Project_SelectedIndexChanged" Width="85%">
        ...
        <tr><td class="Table1">非工作日選擇</td><td colspan="3"><asp:Label id="Label1" runat="server" /></td></tr>
        <tr><td class="Table1" >工作日總數</td><td colspan="3">
            <asp:Label ID="LbWorkDate" runat="server" ></asp:Label></td></tr>
        <tr>
            <td class="Table1">備註</td><td colspan="4">工作日已扣除春節5日、清明節、端午節、中秋節等日(共8日)。</td>
        </tr>
