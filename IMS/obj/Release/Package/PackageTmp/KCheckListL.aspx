<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KCheckListL.aspx.cs" Inherits="IMS.KCheckListL" %>
...
<ItemStyle CssClass="auto-left"></ItemStyle>
                    ...
                    <asp:TemplateField HeaderText="自主檢查表缺失檢視">
                        <ItemTemplate>
                        <asp:Button ID="Button1" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="缺失檢視"  CommandName="history"  CommandArgument='<%# Container.DataItemIndex%>'/>
                    </ItemTemplate>
