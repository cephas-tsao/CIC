     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
		...
		<td class="TableFun1L">
            ...
            <asp:LinkButton ID="LBtnConfirm" runat="server"  OnClick="LBtnConfirm_Click"></asp:LinkButton>
                       ...
                       &nbsp; <asp:ImageButton ID="ImgCal" runat="server" Height="30px" ImageUrl="~/img/cal.png" ToolTip="合約預算計算設定" Width="27px" OnClick="ImgCal_Click" />
		...
		<td class="TableFun1C">
           ...
           <tr>
                <td class="TableFun1L" colspan="7">選擇顯示階層：<asp:DropDownList ID="DDL_LayerSelect" runat="server" AutoPostBack="True" CssClass="DDLshort" OnSelectedIndexChanged="DDL_LayerSelect_SelectedIndexChanged">
                  <asp:ListItem Value="0" Selected="True">-請選擇-</asp:ListItem>              
                        ...
                        <table border="1" style="width: 100%;text-align:center;" class="tree">
                            <tr class="TableTop">
                                <td class="auto-style101" rowspan="2" style="width:10%">編輯</td>
                                <td class="auto-style45" colspan="<%=LbLayerNum %>" rowspan="2" style="width:7%" >項次</td>
                                <td class="auto-style45" rowspan="2" style="width:25%">工項名稱</td>
                                <td class="auto-style45" rowspan="2" style="width:3%">單位</td>
                          ...
                          <%--      <td class="auto-style46" rowspan="2">單價分析</td>--%>
                            ...
                            <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" DataSourceID="SqlDataSource1" OnItemCommand="Repeater1_ItemCommand">
                                <ItemTemplate>
                                      ...
                                      <tr class="<%#setClass(Convert.ToInt32(Eval("order_Num")))%>" id="<%#setClass(Convert.ToInt32(Eval("order_Num")))%>">                                                             
                                <td class="ShtCellCC">                                   
                                    <asp:ImageButton ID="ImgBtnNumBD" runat="server" Height="30px" ImageUrl="~/img/NumBD.png"  ToolTip="拆數量" Width="27px" CssClass="button" CommandName="NumBD" CommandArgument='<%# Container.ItemIndex%>'/>
                                     <asp:ImageButton ID="ImgBtnRlon" runat="server" Height="30px" ImageUrl="~/img/Reallocation.png" ToolTip="拆工料" Width="27px" CssClass="button" CommandName="Relocation" CommandArgument='<%# Container.ItemIndex%>'/>
                                    <%--<asp:ImageButton ID="ImgBtnDel" runat="server" Height="30px" ImageUrl="~/img/Delete.png" ToolTip="刪除項目" Width="27px" CommandName="Delete" CommandArgument='<%# Container.ItemIndex%>' OnClientClick="if (confirm('確認刪除?') == false) return false" Text="刪除"/>--%>
                                       ...
                                       <asp:Label ID="LbUpperWID" runat="server" Visible="false"></asp:Label>
                                       <asp:Label ID="Lborder_Num" runat="server" Visible="false"></asp:Label>
                                       <asp:Label ID="LbSortNum" runat="server" Visible="false"></asp:Label>
                                       <asp:Label ID="LbLayer" runat="server" Visible="false"></asp:Label>
