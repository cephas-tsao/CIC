<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CChangeSummaryA.aspx.cs" Inherits="IMS.CChangeSummaryA" %>
    ...
    <div>
		...
		<td class="auto-style2">
            ...
            <td class="auto-style2">
                                對應版本次別</td>
              <td class="auto-style3" >
            合約預算版本：<asp:DropDownList ID="DropDownList1" Width="100px" runat="server" Enabled="false"></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            執行預算版本：<asp:DropDownList ID="DropDownList2" Width="120px" runat="server">
		...
		<td class="auto-style2">
            ...
            <td class="auto-style2">
                變更後合約總價</td>
            <td class="auto-style3">
                                    <asp:Label ID="TxCamount" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="150px" ></asp:Label>
                                    </td>
		</tr>
		<tr>
		<td class="auto-style2">
