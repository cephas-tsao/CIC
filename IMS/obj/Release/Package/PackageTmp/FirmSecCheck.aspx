<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="Site1.Master" CodeBehind="FirmSecCheck.aspx.cs" Inherits="IMS.FirmSecCheck" %>
<%@ Register TagPrefix="Area" TagName="Firm" Src="~/Webcontrol/FirmMode.ascx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>分包商管理模組-分包商考核(複評)</title>
</asp:Content>
...
<body>
    ...
    <div> 
        ...
        <table class="Table100">
            ...
            <tr>
                ...
                <td class="Table2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"  SelectCommand="SELECT SubContract_Main.SCID, SubContract_Main.SC_Name FROM SubContract_Main LEFT OUTER JOIN Firm_Check ON SubContract_Main.SCID = Firm_Check.SCID WHERE (SubContract_Main.PID = @PID) AND (Firm_Check.FirstResult IS NOT NULL)">
                        <SelectParameters>
        ...
        <asp:Panel ID="Pnl_Main" runat="server" DefaultButton="checkBtn">
            ...
            <asp:Panel ID="Pnl_1" runat="server" Enabled="False">
                <table class="Sht100">
                    ...
                    <tr class="ShtRowExecuteSoft">
                        ...
                        <td class="ShtCellCL">總分：<asp:Literal ID="Literal4" runat="server"></asp:Literal></td>
                        <td class="ShtCellCL">考核人：<asp:Literal ID="Literal1" runat="server"></asp:Literal></td>
                        <td class="ShtCellCL">考核日期：<asp:Literal ID="Literal2" runat="server"></asp:Literal></td>
                        <td class="ShtCellCL">考核結果：<div id="show" runat="server"><asp:Literal ID="LtResult" runat="server"></asp:Literal></div></td>
                        <td class="ShtCellCL" colspan="2">說明：<asp:TextBox ID="TextBox8" runat="server" CssClass="TBlong"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
