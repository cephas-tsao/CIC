<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Site1.Master" CodeBehind="SubContractM.aspx.cs" Inherits="IMS.SubContractM" MaintainScrollPositionOnPostback="true" %>
...
<script type="text/javascript" src="../js/datePicker/WdatePicker.js">  
    ...
    <div>
		...
		<td class="auto-style3C">
            <asp:Panel runat="server" ID="panel" DefaultButton="BtnSearch">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" 
                                      OnRowCommand="GridView1_RowCommand"  OnRowDataBound="GridView1_RowDataBound"  GridLines="None" Width="100%">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="Button42" runat="server" CssClass="BtnFree" OnClick="Button42_Click" Text="編修分包合約" Font-Names="微軟正黑體" Font-Size="Medium" CommandName="select" CommandArgument='<%# Container.DataItemIndex %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
        ...
        <asp:Panel ID="Pnl_Contract" runat="server" Visible="False" onkeydown = "return (event.keyCode!=13)">
            ...
            <asp:Panel ID="Pnl_main" runat="server">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="DDL_ContractType" runat="server" AutoPostBack="True" Font-Names="微軟正黑體" Font-Size="Medium" Height="35px" OnSelectedIndexChanged="DropDownList9_SelectedIndexChanged1" Width="200px">
                                <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="DDL_GuaranteeWay" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="35px" Width="200px">
                                <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                        ...
                        <td class="auto-style3"><asp:TextBox ID="TxSubmitPercent" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="50px"></asp:TextBox>
                            %提送</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style3">
                            每月<asp:TextBox ID="TxRequestDate" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="50px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                            <asp:DropDownList ID="DDL_Warranty" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="35px" Width="200px" AutoPostBack="true">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="auto-style3C">
                            ...
                            %</td>
                        <td class="auto-style3C">
                            <asp:TextBox ID="TxPrepayCash" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="80px" AutoPostBack="true" OnTextChanged="TxPrepayCheck_TextChanged"></asp:TextBox>
                            %</td>
                        <td class="auto-style3C">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3C">
                            <asp:TextBox ID="TxFundCash" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="80px" AutoPostBack="true" OnTextChanged="TxPrepayCheck_TextChanged"></asp:TextBox>
                            %</td>
                        <td class="auto-style3C">
                    ...
                    <tr>
                        <td class="auto-style3C">
                            ...
                            %</td>
                        <td class="auto-style3C">
                            <asp:TextBox ID="TxRetentionCash" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="80px" AutoPostBack="true" OnTextChanged="TxPrepayCheck_TextChanged"></asp:TextBox>
                            %</td>
                        <td class="auto-style3C">
                    ...
                    <tr>
                        <td class="auto-style3C">
                            ...
                            %</td>
                        <td class="auto-style3C">
                            <asp:TextBox ID="TxWarrantyCash" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="20px" Width="80px" AutoPostBack="true" OnTextChanged="TxPrepayCheck_TextChanged"></asp:TextBox>
                            %</td>
                        <td class="auto-style3C">
                                     ...
                                     <%--   <asp:CommandField ButtonType="Button" ShowDeleteButton="True" SelectText="下載" ShowSelectButton="True">
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                 ...
                                                 <asp:Button ID="BtnDel" runat="server" CssClass="BtnFree" OnClick="Button42_Click" Text="刪除"  CommandName="Delete" CommandArgument='<%# Container.DataItemIndex %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
            ...
            <table style="width: 100%">
                <tr>
                    <td class="auto-style2">
                        <asp:Button ID="BtnSave" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium" Text="儲存修改" OnClick="BtnSave_Click" />
                        &nbsp;&nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="BtnDelete" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium" Text="刪除分包合約" OnClick="BtnDelete_Click" />
                    </td>
                </tr>
            </table>
            <br />
