<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OFundIncreaseM.aspx.cs" Inherits="IMS.OFundIncreaseM" %>
    ...
    <div>
        ...
        <asp:Panel ID="Pnl_View" runat="server">
            <table class="Table100">
                <tr>
                    <td class="Table2C">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="OF_MID" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" onrowdatabound="GridView1_RowDataBound" EmptyDataText="搜尋結果尚無資料">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button ID="Button1" runat="server" CommandName="Select" CssClass="BtnFree" Text="編輯/刪除" Visible='<%# (Convert.ToInt32(DataBinder.Eval(Container.DataItem,"BelongOFID"))==0)? true:false %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="OF_MID" HeaderText="OF_MID" InsertVisible="False" ItemStyle-HorizontalAlign="Center" ReadOnly="True" SortExpression="FF_MID" Visible="False">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Type" HeaderText="扣款類型" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Modify.Type">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Subject" HeaderText="扣款事由" SortExpression="OFund_Modify.Subject" />
                                <asp:BoundField DataField="Date" DataFormatString="{0:d}" HeaderText="發生日期" HtmlEncode="False" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Modify.Date">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SumPrice" HeaderText="扣款總額" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Modify.SumPrice">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Recorder" HeaderText="記錄人員" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Modify.Recorder">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="OF_Code" HeaderText="請款單號" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Main.OF_Code">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="OF_Edition" HeaderText="請款期別" ItemStyle-HorizontalAlign="Center" SortExpression="OFund_Main.OF_Edition">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="Select * From OFund_Modify LEFT OUTER JOIN OFund_Main ON OFund_Modify.BelongOFID = OFund_Main.OFID WHERE OFund_Modify.PID = @PID And OFund_Modify. IncreaseDebit='I'">
                            <SelectParameters>
