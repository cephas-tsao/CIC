...
namespace IMS
{
    public partial class FFundDebitAssign1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            decimal SUM_SumPrice = DAL.FirmFundMode.SumPrice_Search_11(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["FFID"]), "D");
            Result = DAL.FirmFundMode.Update_FFundDebitAssign_3(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["FFID"]), SUM_SumPrice, "Item7");
            if (Result)
            {
        ...
        {
            bool Result = DAL.FirmFundMode.FFund_Search3(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["SCID"]), "D");
            if (Result)
            {
