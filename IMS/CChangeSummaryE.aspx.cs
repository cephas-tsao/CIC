...
namespace IMS
{
    public partial class CChangeSummaryE : System.Web.UI.Page
    {
        ...
        protected void LoadContent()
        {
            ...
            if (ID != "")
            {
                string SQLString = "Select * From CBudget_Change Where PID= " + Session["ProjectCode"] + " And CEdition=" + ID + "";
                ...
                if (DataTableBox != null && DataTableBox.Rows.Count > 0)
                {
                    foreach (DataRow row in DataTableBox.Rows)
                    {
                        ...
                        LbNum.Text = row["CEdition"].ToString();
        ...
        protected DataTable GetDataBox()
        {
            ...
            string SQLString = "PID,CEdition,ApprovedDate,ApprovedDoc,AdjestDuration,AdjestBookFinishDate,AdjestPrice,AdjestTotalPrice,Notes";
            ...
            if (Session["ProjectCode"] != null)
            {
                ...
                DataTableDr["CEdition"] = LbNum.Text;
        ...
        {
            string database = Session["DatabaseName"].ToString();
            bool result = WebModel.EditAction_Anyid(database, "CBudget_Change","UID", ID, GetDataBox());
            if (result )
            {
