...
namespace IMS
{
    public partial class OFundDebitAssign : System.Web.UI.Page
    {
        ...
        {
            bool Result = DAL.OFundMode.OFund_Search3(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["PID"]), "D");
            if (Result)
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            decimal SUM_SumPrice = DAL.OFundMode.SumPrice_Search_11(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["OFID"]), "D");
            Result = DAL.OFundMode.Update_OFundDebitAssign_3(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["OFID"]), SUM_SumPrice, "OItem9");
            if (Result)
            {
