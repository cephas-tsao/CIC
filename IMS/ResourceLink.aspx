<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceLink.aspx.cs" Inherits="IMS.ResourceLink" %>
    ...
    <div>
      <table class="Table100">
                                <tr>
                                    ...
                                    <table class="Table100">
                                        <tr>
                                            <td class="TableTop">標案專屬工料資料庫</td>
                                        </tr>
                                        <tr>
                                            <td class="Table2">
                                                <table class="Table100">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" 
                                                    CellPadding="3" CellSpacing="1" DataKeyNames="PriceID" DataSourceID="SqlDataSource1" GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="單價分析" SortExpression="Complex">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Button ID="Button23" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Text="查詢單價分析" CommandName="analyst"  CommandArgument='<%# Container.DataItemIndex%>'
                                                                     Visible='<%# (Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Complex"))==1)? true:false %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
