    ...
    public partial class ChangeCBudget : System.Web.UI.Page
    {
        ...
        protected void DataContent()
        {
                ...
                if (vsDt.Rows.Count > 0)
                {
                    for (int i = 0; i < vsDt.Rows.Count; i++)
                    {
                        ...
                        if (change != "")
                        {
                            ...
                            if (layer == "1")
                            {
                                ...
                                ListStr2 = @"<tr style=""background-color:white"" class=""treegrid-{14}"" id=""tr{14}""> <td style=""width: 100px"">
                                 <a href=""{12}"" {13}> <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""25px""  style=""visibility:{11};float:right;vertical-align:middle;""  /></a></td>
                 ...
                 <a href=""{12}"" {13}> <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""40px""  style=""visibility:{11}""  /></a></td>      
                            ...
                            else
                            {
                                ...
                                ListStr2 = @"<tr style=""background-color:white"" class=""treegrid-{14} treegrid-parent-{15}"" id=""tr{14}""> <td style=""width: 100px"">
                                 <a href=""{12}"" {13}> <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""25px""  style=""visibility:{11};float:right;vertical-align:middle;""  /></a></td>
                                 <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                                <Label ID=""LbPriceID"" Visible=""false"" Text=""{1}""></Label>
                                {2}{3}
                        ...
                        else
                        {
                            ...
                            if (layer == "1")
                            {
                                ...
                                ListStr2 = @"<tr class=""background-color:white"" class=""treegrid-{14}"" id=""tr{14}""> <td style=""width: 3px"">
                                </td><Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>                         
                    </td>           
                            ...
                            else
                            {
                                ...
                                ListStr2 = @"<tr class=""background-color:white"" class=""treegrid-{14} treegrid-parent-{15}"" id=""tr{14}""> <td style=""width: 3px"">
                                </td> <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                                <Label ID=""LbPriceID"" Visible=""false"" Text=""{1}""></Label>
                                {2}{3}
                                <td class=""autoLeft"">{4}</td>
            ...
            if (CheckBoxList2.SelectedValue != "")
            {
                ...
                ListStr3 = @"<tr class=""ShtRowSingle"" id=""tr{12}"">
                 <td style=""width: 30px"">
                        ...
                        if (vsDt1.Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < vsDt1.Rows.Count; i++)
                            {
                                ...
                                if (layer == "1")
                                {
                                    ...
                                    ListStr3 = @"<tr background-color:white"" class=""treegrid-{12}"" id=""tr{12}"">
                                 <td style=""width:120px"">
                                 <a href=""javascript:window.open('{10}','window','height=500,width=950')"" > <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""30px""  style=""visibility:{9};float:right;vertical-align:middle;"" /></a></td>
                                 <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                                <Label ID=""LbPriceID"" Visible=""false"" Text=""{1}""></Label>
                                {2}{3}
                                <td class=""autoLeft"">{4}</td>
                                ...
                                else
                                {
                                    ...
                                    ListStr3 = @"<tr background-color:white"" class=""treegrid-{12} treegrid-parent-{13}"" id=""tr{12}"">
                                 <td style=""width:120px"">
                                 <a href=""javascript:window.open('{10}','window','height=500,width=950')"" > <img src=""../img/Edit.png"" ToolTip=""逐項編輯"" Width=""30px""  style=""visibility:{9};float:right;vertical-align:middle;"" /></a></td>
                                 <Label ID=""LbWid""  Visible=""false"" Text=""{0}""></Label>
                                <Label ID=""LbPriceID"" Visible=""false"" Text=""{1}""></Label>
