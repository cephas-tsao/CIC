...
namespace IMS
{
    public partial class BidPayE : System.Web.UI.Page
    {
        string _TableName = "BidM3";
        string ErrorString = "";
        string SQLString = "bid,PrepayPercentage,EstAcceptNum,EstAcceptUnit,EstAcceptDate1,EstAcceptDate2,RetentionPercentage,PriceSubsidyNY,OtherPayment";
