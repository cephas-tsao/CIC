<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OFundIncreaseApproval.aspx.cs" Inherits="IMS.OFundIncreaseApproval" %>
...
<table class="Table100">
    <tr>
       ...
       <table class="Table100">
        ...
        <table class="Table100">
            <tr>
                <td class="Table0">
                    <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="White" OnClick="LinkButton2_Click">加款明細</asp:LinkButton>
                </td>
            </tr>
        </table>
    ...
    <asp:GridView id="GridView1" runat="server"  DataKeyNames="OF_MID" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" Width="100%" ForeColor="#333333" GridLines="None" EmptyDataText="搜尋結果尚無資料">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Subject" HeaderText="加款事由" SortExpression="Subject" ItemStyle-HorizontalAlign="Center">
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="Type" HeaderText="加款類型" SortExpression="Type" ItemStyle-HorizontalAlign="Center">
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="Price" HeaderText="加款金額" SortExpression="Price" ItemStyle-HorizontalAlign="Center">                               
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="Tax" HeaderText="稅金" SortExpression="Tax" ItemStyle-HorizontalAlign="Center">
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="SumPrice" HeaderText="加款總額" SortExpression="SumPrice" ItemStyle-HorizontalAlign="Center"> 
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:BoundField>
