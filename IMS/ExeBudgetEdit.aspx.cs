    ...
    public partial class ExeBudgetEdit : System.Web.UI.Page
    {
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {              
                ...
                Label LbUpperWID = (Label)e.Item.FindControl("LbUpperWID");
                Label Lborder_Num = (Label)e.Item.FindControl("Lborder_Num");
                Label LbSortNum = (Label)e.Item.FindControl("LbSortNum");
                Label LbLayer = (Label)e.Item.FindControl("LbLayer");
             ...
             LbUpperWID.Text = vsDr["UpperWID"].ToString();
             Lborder_Num.Text = vsDr["order_Num"].ToString();
             LbSortNum.Text = vsDr["SortNum"].ToString();
             LbLayer.Text = vsDr["LayerNum"].ToString();

             //if (layer == "1")
             //{
             //    ((HtmlGenericControl)(e.Item.FindControl("trID"))).Attributes["class"] = "treegrid-" + sort;

             //}
             //else
             //{
             //    ((HtmlGenericControl)(e.Item.FindControl("trID"))).Attributes["class"] = "treegrid-" + sort + " treegrid-parent-" + Find_order_Num;
             ...
             sort++;
                ...
                {
                    decimal n1 = (vsDr["ENumber"].ToString() != "") ? decimal.Parse(vsDr["ENumber"].ToString()) : 0;
                    int x = int.Parse(SystemSet.GetRequestSet("TxDecmal1"));

                    LbENumber.Text = (LbENumber.Text != "0") ? Math.Round(n1, x).ToString("N" + x) : "-";
                ...
                {
                    LbENumber.Text = (vsDr["ENumber"].ToString() != "") ? Convert.ToInt32(Math.Ceiling(decimal.Parse(vsDr["ENumber"].ToString()))).ToString("N") : "-";

                }
                else if (SystemSet.GetRequestSet("RBLRuleValue1") == "2")
                {
                    LbENumber.Text = (vsDr["ENumber"].ToString() != "") ? Convert.ToInt32(Math.Floor(decimal.Parse(vsDr["ENumber"].ToString()))).ToString("N") : "-";

                }
                //原標單單價
                if (SystemSet.GetRequestSet("RBLRuleValue2") == "0")
                {
                    decimal n1 = (vsDr["EUnitPrice"].ToString() != "") ? decimal.Parse(vsDr["EUnitPrice"].ToString()) : 0;
                    int x = SystemSet.GetRequestSet("TxDecmal2") != "" ? int.Parse(SystemSet.GetRequestSet("TxDecmal2")) : 0;
                    LbEPrice.Text = Math.Round(n1, x).ToString("N" + x);
                ...
                {
                    LbEPrice.Text = (vsDr["EUnitPrice"].ToString() != "") ? Convert.ToInt32(Math.Ceiling(decimal.Parse(vsDr["EUnitPrice"].ToString()))).ToString("N") : "-";

                }
                else if (SystemSet.GetRequestSet("RBLRuleValue2") == "2")
                {
                    LbEPrice.Text = (vsDr["EUnitPrice"].ToString() != "") ? Convert.ToInt32(Math.Floor(decimal.Parse(vsDr["EUnitPrice"].ToString()))).ToString("N") : "-";
                ...
                if (SystemSet.GetRequestSet("RBLRuleValue3") == "0" && SystemSet.GetRequestSet("TxDecmal3") != "")
                {
                    ...
                    LbENumber.Text = (LbENumber.Text != "-" && (LbENumber.Text != "")) ? LbENumber.Text : "0";
                    decimal n1 = (decimal.Parse(LbENumber.Text) * decimal.Parse(LbEPrice.Text));
                    LbEComplex.Text = Math.Round(n1, x).ToString("N" + x);
                ...
                else if (SystemSet.GetRequestSet("RBLRuleValue3") == "1")
                {
                    LbENumber.Text = (LbENumber.Text != "-" && LbENumber.Text != "") ? LbENumber.Text : "0";
                    decimal n1 = (decimal.Parse(LbENumber.Text) * decimal.Parse(LbEPrice.Text));
                    LbEComplex.Text = Math.Ceiling(n1).ToString("N");
                ...
                else if (SystemSet.GetRequestSet("RBLRuleValue3") == "2")
                {
                    LbENumber.Text = (LbENumber.Text != "-" && LbENumber.Text != "") ? LbENumber.Text : "0";
                    decimal n1 = (decimal.Parse(LbENumber.Text) * decimal.Parse(LbEPrice.Text));
                    LbEComplex.Text = Math.Floor(n1).ToString("N");
                ...
                int x1 = int.Parse(LbLayerNum) - int.Parse(layer) +1;//- int.Parse(layer)
                ...
                Literal1.Text += @"<td  colspan= " + x1 + ">" + Order + "</td>";
                //if (check.Checked)
                //{
        ...
        int sort = 1;
        protected string setClass(int order_Num)
        {
            string classToApply = string.Empty;
            string database = Session["DatabaseName"].ToString();
           
            string SQLSelect = "Select * from EBudget_WBS where PID="+Session["ProjectCode"].ToString()+" and order_Num="+order_Num;
            ...
            if (Dtvs != null && Dtvs.Rows.Count > 0)
            {
                ...
                {
                    string LayerNum = row["LayerNum"].ToString();
                    string EWid = row["EWid"].ToString();
                    string UpperWID = row["UpperWID"].ToString();
                    string SortNum=row["SortNum"].ToString();
                    string order_Num1 = row["order_Num"].ToString();
                    string Find_order_Num = EBudgetDisp.Get_Order(database, Session["ProjectCode"].ToString(), EWid, UpperWID, order_Num1, SortNum);
                    if (LayerNum == "1")
                    {
                        classToApply = "treegrid-" + order_Num;
                     
                       
                    }
                    else
                    {
                        classToApply = "treegrid-" + order_Num + " treegrid-parent-" + Find_order_Num;
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "newWindow", string.Format("<script type='text/javascript'>window.open('ETuneDecimal.aspx', 'window','height=450,width=1500');</script>"));
        }
    }
}