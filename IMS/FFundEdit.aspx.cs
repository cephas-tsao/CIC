...
namespace IMS
{
    public partial class FFundEdit : System.Web.UI.Page
    {
        ...
        {
            OpenNewWindowA("FFundItemEdit.aspx", "A");
        }
        ...
        {
            OpenNewWindowB("FFundDebitAssign.aspx", "A");
        }
        protected void Button11_Click(object sender, EventArgs e)
        {
            OpenNewWindowB("FFundIncreaseAssign.aspx", "A");
        }
        protected void Button1_Click(object sender, EventArgs e)
        {
            Pnl_2.Visible = true;
            Button lbtn = (Button)sender;
            DAL.Temp3.cc = Convert.ToInt32(lbtn.CommandArgument);
        ...
        protected void Button15_Click(object sender, EventArgs e)
        {
            ...
            Session["Edition"] = DAL.FirmFundMode.Edition_Search(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["PID"]), Convert.ToInt32(Session["SCID"]));
            Date_Load_1 = DAL.FirmFundMode.Insert_FFundEdit_1(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["PID"]), Convert.ToInt32(Session["SCID"]), Convert.ToInt32(Session["Edition"]));
            Session["FFID"] = DAL.FirmFundMode.FFID_Search(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["SCID"]), Convert.ToInt32(Session["Edition"]));
            DAL.FirmFundMode.SC_MID_Search(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["SCID"]));
            Date_Load_2 = DAL.FirmFundMode.Insert_FFundEdit_2(Session["DatabaseName"].ToString(), Convert.ToInt32(Session["FFID"]));
        ...
        {
            TextBox22.Text = (Convert.ToDecimal(TextBox8.Text) + Convert.ToDecimal(TextBox20.Text) - Convert.ToDecimal(TextBox21.Text)).ToString("N");
            TextBox23.Text = (Convert.ToDecimal(TextBox22.Text) * Convert.ToDecimal(TextBox36.Text) / 100).ToString("N");
            TextBox30.Text = (Convert.ToDecimal(TextBox22.Text) + Convert.ToDecimal(TextBox23.Text) - Convert.ToDecimal(TextBox24.Text) - Convert.ToDecimal(TextBox25.Text) + Convert.ToDecimal(TextBox26.Text) + Convert.ToDecimal(TextBox27.Text) + Convert.ToDecimal(TextBox28.Text) + Convert.ToDecimal(TextBox29.Text)).ToString("N");
            if (Convert.ToDecimal(TextBox22.Text) < 0 || Convert.ToDecimal(TextBox30.Text) < 0)
            {
        ...
        protected void Button16_Click(object sender, EventArgs e)
        {
            ...
            Date_Load = DAL.FirmFundMode.Delete_FFund_Main_and_Item(Session["DatabaseName"].ToString(), DAL.Temp3.cc);
            if (Date_Load)
            {
        ...
        {
            int k = 0;
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "FF_Code", TextBox1.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "StartDate", TextBox2.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "FundDate", TextBox3.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "EndDate", TextBox4.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "PayDate", TextBox5.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Note", TextBox7.Text);

            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item1", TextBox8.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item2", TextBox20.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item3", TextBox21.Text);
            TextBox22.Text = (Convert.ToDecimal(TextBox8.Text) + Convert.ToDecimal(TextBox20.Text) - Convert.ToDecimal(TextBox21.Text)).ToString();
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item4", TextBox22.Text);
            TextBox23.Text = (Convert.ToDecimal(TextBox22.Text) * Convert.ToDecimal(TextBox36.Text) / 100).ToString();
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item5", TextBox23.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item6", TextBox24.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item7", TextBox25.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item8", TextBox26.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item9", TextBox27.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item10", TextBox28.Text);
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item11", TextBox29.Text);
            TextBox30.Text = (Convert.ToDecimal(TextBox22.Text) + Convert.ToDecimal(TextBox23.Text) - Convert.ToDecimal(TextBox24.Text) - Convert.ToDecimal(TextBox25.Text) + Convert.ToDecimal(TextBox26.Text) + Convert.ToDecimal(TextBox27.Text) + Convert.ToDecimal(TextBox28.Text) + Convert.ToDecimal(TextBox29.Text)).ToString();
            k += DAL.FirmFundMode.Update_FFund_Main(Session["DatabaseName"].ToString(), DAL.Temp3.cc, "Item12", TextBox30.Text);
        ...
        //    SqlDataSource2.ConnectionString = Utility.DBconnection.connect_string(Session["DatabaseName"].ToString());
        //    SqlDataSource2.SelectCommand = "Select * From FFund_Main Where SCID = " + Session["SCID"] + " and PID = " + Session["PID"];
        //    DataView dv = (DataView)this.SqlDataSource2.Select(new DataSourceSelectArguments());
