<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PriceAnalysis.ascx.cs" Inherits="IMS.WebControl.PriceAnalysis" %>
<!--=========slider_scroll======================-->
            <div id="slider_scroll" >
                ...
                <div id="slider_content">
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse" id="sidenav">
                        <li class="active"><a href="#">工料管理</a></li>
                        <li><a href="PriceAnalysis.aspx">工料管理</a></li>                 
