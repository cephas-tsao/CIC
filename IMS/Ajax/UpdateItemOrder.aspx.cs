...
namespace IMS.Ajax
{
    public partial class UpdateItemOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.asaction == "addsave")
            {
                ...
                if (DataTableBox != null && DataTableBox.Rows.Count > 0)
                {
                    ...
                    {
                        wid = int.Parse(row["EWID"].ToString());
                        main(wid);
                    }
                }
        ...
        public void main(int UID1)
        {
            ...
            string[] ItemOrder = new string[DataTableBox.Rows.Count];
            ...
            if (DataTableBox != null && DataTableBox.Rows.Count > 0)
            {
                ...
                foreach (DataRow row in DataTableBox.Rows)
                {
                    WID[count] = int.Parse(row["EWID"].ToString());
            ...
            string SQLLayerCode = "update EBudget_WBS set ItemOrder='" + result1 + "' where EWID = " + UID1 + "";
