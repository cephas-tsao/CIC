...
namespace IMS
{
    public partial class BidDurationNew : System.Web.UI.Page
    {
            ...
            if (ErrorString == "")
            {
                ...
                else
                {
                    //確認資料庫是否有資料
                       ...
                       string result= WebModel.SaveAction_BID(database, _TableName, GetDataBox());
                        ...
                        if (result !="0")
                    {
                       ...
                       // Response.Write("<script>window.showModelessDialog('BidDurationE.aspx')</script>");
                        Response.Write("<script>window.opener.document.getElementById('callback').click();</script>");                       
                        //Response.Write("<script>window.open('BidDurationE.aspx')</script>");
                    }
                    else
                    {
