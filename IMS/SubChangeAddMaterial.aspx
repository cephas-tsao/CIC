<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubChangeAddMaterial.aspx.cs" Inherits="IMS.SubChangeAddMaterial" %>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
                                                    ...
                                                    <tr class="ShtRowTop">
                                                        ...
                                                        <td class="ShtCellCC"><asp:Label ID="LbLastSubNumber" runat="server" Font-Names="微軟正黑體" ></asp:Label></td>
                                                         ...
                                                         <td class="ShtCellCC"><asp:Textbox ID="TxunitPrice" runat="server" Font-Names="微軟正黑體" ></asp:Textbox></td>
                                                        <td class="ShtCellCC">
                                                                                ...
                                                                                <asp:Panel ID="Pnl_SourceList" runat="server" Visible="False">
                                                                                    <table class="Table3">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="auto-style33">分包單價</td>
                                                                                            <td class="auto-style345">
                                                                                                 <asp:TextBox ID="TxSubPrice" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" ></asp:TextBox>
                                                                                            </td>
