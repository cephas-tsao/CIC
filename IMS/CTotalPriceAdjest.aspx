<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTotalPriceAdjest.aspx.cs" Inherits="IMS.CTotalPriceAdjest" %>
<!DOCTYPE html>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td class="auto-style3">
                                    <asp:Label ID="LB_NormalPrice" runat="server" ></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style3">
                                    <asp:TextBox ID="TB_Percent" runat="server" Font-Names="微軟正黑體" Font-Size="Medium" Height="25px" Width="190px" AutoPostBack="True" OnTextChanged="TB_Percent_TextChanged"></asp:TextBox>
                                    ％</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style2" colspan="3">
                                    <asp:Button ID="CAL" runat="server" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Large" Height="53px" Text="計算總價調整" OnClick="CAL_Click" />
                                </td>
                            </tr>
                        </table>
                                </td>
