<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FFundView.aspx.cs" Inherits="IMS.FFundView" %>
    ...
    <div>
        ...
        <table class="Table100">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" Width="100%" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" DataKeyNames="FFID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" onrowdatabound="GridView1_RowDataBound" AllowPaging="True" EmptyDataText="搜尋結果尚無資料">
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="Button1" runat="server" CommandName="Select" CssClass="BtnFree" Text="明細" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="FF_Edition" HeaderText="計價期別" SortExpression="FF_Edition" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="FF_Code" HeaderText="計價單號" SortExpression="FF_Code" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="StartDate" HeaderText="估驗起始日期" SortExpression="StartDate" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" HtmlEncode="False" />
                    <asp:BoundField DataField="EndDate" HeaderText="估驗截止日期" SortExpression="EndDate" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" HtmlEncode="False" />
                    <asp:BoundField DataField="FundDate" HeaderText="計價日期" SortExpression="FundDate" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" HtmlEncode="False" />
                    <asp:BoundField DataField="PayDate" HeaderText="付款日期" SortExpression="PayDate" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" HtmlEncode="False" />
                    <asp:BoundField DataField="Item12" HeaderText="實付金額" SortExpression="Item12" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="Note" HeaderText="備註說明" SortExpression="Note" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="Select * From FFund_Main Where SCID= @SCID">
                <SelectParameters>
        ...
        <table class="Table100">
            ...
            <tr>
                ...
                <table class="Table100">
                    <tr>
                        <td class="auto-style1">項次</td>
                        <td class="auto-style1">項目</td>
                        <td class="auto-style1">前期累計</td>
                        <td class="auto-style1">本期計價</td>
                        <td class="auto-style1">至本期累計</td>
                    ...
                    <tr>
                        ...
                        <td class="Table2C">
                            <asp:TextBox ID="TextBox22" runat="server" CssClass="TBmiddle" style="text-align:right" ></asp:TextBox>
                        </td>
                        <td class="Table2R">
                    ...
                    <tr>
                        ...
                        <td class="Table2C">
                            <asp:TextBox ID="TextBox30" runat="server" CssClass="TBmiddle" style="text-align:right" ></asp:TextBox>
                        </td>
                        <td class="Table2R">
