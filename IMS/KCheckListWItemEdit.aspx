<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KCheckListWItemEdit.aspx.cs" Inherits="IMS.KCheckListWItemEdit" %>
...
<body>
   <div>
	...
	<tr>
		...
		<asp:TextBox id="NewKCheckListItemName" runat="server"  CssClass="TB500"></asp:TextBox>
    ...
    <table class="Table100">
     ...
     <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" GridLines="None" DataKeyNames="KCheckListItemId"  DataSourceID="SqlAll" AutoGenerateColumns="False" ForeColor="#333333" OnRowCommand="GridView1_RowCommand">
                ...
                <asp:ImageButton ID="Button2" runat="server" 
                  ...
                  <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label runat="server" ID="ID" Text='<%# Eval("KCheckListItemId")%>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>         
           ...
           <HeaderStyle Wrap="False"  />
            <ItemStyle  HorizontalAlign="Center" VerticalAlign="Middle" />
                    ...
                    <asp:BoundField DataField="KCheckListItemId" HeaderText="UID" InsertVisible="False" ReadOnly="True" SortExpression="UID" Visible="false" />
                    <asp:BoundField DataField="KCheckListItemName" HeaderText="檢查項目名稱" SortExpression="檢查項目名稱" ItemStyle-CssClass="auto-center">
<ItemStyle CssClass="auto-center" HorizontalAlign="Left"></ItemStyle>
     ...
     <asp:GridView ID="GridView2" runat="server" Width="100%" CellPadding="4" GridLines="None" DataKeyNames="KCheckListItemId" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" ForeColor="#333333" OnRowCommand="GridView2_RowCommand" >
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:TemplateField  HeaderText="編輯">
                               <ControlStyle Font-Names="微軟正黑體" Font-Size="Medium"  CssClass="button" />
...
<ItemStyle CssClass="auto-center" HorizontalAlign="Left"></ItemStyle>
     ...
     <asp:GridView ID="GridView3" runat="server" Width="100%" CellPadding="4" GridLines="None" DataKeyNames="KCheckListItemId" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" ForeColor="#333333" OnRowCommand="GridView3_RowCommand">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:TemplateField  HeaderText="編輯">
                               <ControlStyle Font-Names="微軟正黑體" Font-Size="Medium"  CssClass="button" />
