<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectWarrantyE.aspx.cs" Inherits="IMS.ProjectWarrantyE" %>
...
<form id="form1" runat="server">
	...
	<table class="Table100">
		...
		<tr>
        	...
        	<table  class="Table100">
				<tr>
					<td class="Table1" style="width: 110px">新增保固明細</td>
		...
		<tr>
			...
			<table style="width: 100%">
			    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="WarrantyID" DataSourceID="ProjectWarranty" Width="100%" OnRowUpdating="GridView1_RowUpdating" >
         <Columns>
            ...
            <asp:TemplateField ShowHeader="False" >
             ...
             <asp:TemplateField Visible="false">
                 <ItemTemplate>
                    <asp:label runat="server" ID="WarrantyID" ReadOnly="True" SortExpression="ElementID" Visible="False" />
                 </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="保固年限(年)">
                ...
                <SortedDescendingHeaderStyle BackColor="#4870BE" />
                 ...
                 <asp:SqlDataSource ID="ProjectWarranty" runat="server" DeleteCommand="DELETE FROM [ProjectM_Warranty] WHERE [WarrantyID] = @WarrantyID"  SelectCommand="SELECT * FROM [ProjectM_Warranty]" 
                     UpdateCommand="UPDATE [ProjectM_Warranty] SET [WarrantyItem] = @WarrantyItem, [WarrantyYear] = @WarrantyYear WHERE [WarrantyID] = @WarrantyID">
        <DeleteParameters>
