...
namespace IMS
{
    public partial class ETuneDecimal : System.Web.UI.Page
    {
        ...
        protected void ReCal_Click(object sender, EventArgs e)
        {
            ...
            //if (Session["Bid"] != null)
            //{
            Response.Write("<script>window.open('ExeBudgetEdit.aspx?RBLRuleValue1=" + RBLRuleValue1 + "&TxDecmal1=" + TxDecmal1 + "&RBLRuleValue2=" + RBLRuleValue2 + "&TxDecmal2=" + TxDecmal2 + "&RBLRuleValue3=" + RBLRuleValue3 + "&TxDecmal3=" + TxDecmal3 + "&Pid=" + Session["ProjectCode"].ToString() + "','_blank')</script>");
            //}
        }
    }
}