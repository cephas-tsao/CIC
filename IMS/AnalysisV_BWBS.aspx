<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisV_BWBS.aspx.cs" Inherits="IMS.AnalysisV_BWBS" %>
            ...
            <Columns>
              ...
              <asp:TemplateField HeaderText="序號" HeaderStyle-Width="3%">
                ...
                <asp:TemplateField HeaderText="數量">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="Number" Text='<%# Bind("CNumber") %>' CssClass="Num_text_align"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
