<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicAnalysisEdit.aspx.cs" Inherits="IMS.PublicAnalysisEdit" %>
...
<body>
    ...
    <div>
                            ...
                            <table class="Table100">
                                <tr>
                                    <td class="TableTop" colspan="8">編輯單價分析</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="Table2LC">
                                        <asp:TextBox ID="TxAnaNumber" runat="server" Font-Size="Large" Font-Bold="True" CssClass="TBshort"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="GridView2_RowCommand" OnRowDataBound="GridView2_RowDataBound" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TxSort" runat="server" Text='<%# Bind("SortNum") %>'  CssClass="TBshort"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="工料項目種類" >
                                            <ItemTemplate>
                                               <asp:DropDownList ID="ItemKind" runat="server" Font-Size="Medium" Height="30px">
                                        ...
                                        <asp:TemplateField HeaderText="單價分析" ItemStyle-Width="3%" >
                                            <ItemTemplate>
                                                 <asp:ImageButton ID="Complex" runat="server"  ImageUrl="~/img/Ana.jpg"   Visible='<%# (Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Complex"))==1)? true:false %>' Enabled="false" />  <%--Visible='<%# aaaa()  %>'  --%>                                               
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                 <asp:ImageButton ID="Complex" runat="server"  ImageUrl="~/img/Ana.jpg"   Visible='<%# (Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Complex"))==1)? true:false %>' />
                                            </EditItemTemplate>

<ItemStyle Width="3%" HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="數量" >
                                            <ItemTemplate>
                                                  <asp:TextBox ID="Quantity" runat="server" Text='<%# Bind("WorkRate") %>' CssClass="TBshort"></asp:TextBox>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                  <asp:TextBox ID="Quantity" runat="server" Text='<%# Bind("WorkRate") %>' CssClass="TBshort"></asp:TextBox>
                                            </EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="備註" >
                                            <ItemTemplate>
                                                 <asp:TextBox ID="Notes" runat="server" Text='<%# Bind("Notes") %>' CssClass="TBshort"></asp:TextBox>
                            ...
                            <table class="Table100">
                                    <tr>
                                    <td class="Table0"  style="text-align:left">
                                        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" CssClass="LBtnStyle">自共用工料庫代入</asp:LinkButton>
                                        </td>
                                </tr>
                                    <tr>
                                    <td class="Table2LC">
                                                ...
                                                <tr>
                                                    <td class="Table2LC">
                                                        <table class="Table100">
                                                            ...
                                                            <tr>
                                                                <td class="Table2CC">
                                                                    <asp:DropDownList ID="DDL_WBS" runat="server" AutoPostBack="True" Font-Size="Medium" CssClass="DDLfree">
                                                                         <asp:ListItem Value="0">-請選擇-</asp:ListItem>
                                                                ...
                                                                <td class="Table2CC">
                                                                    <asp:TextBox ID="TxSearch" runat="server" Font-Size="Medium" CssClass="TBfree"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Price" runat="server" Text='<%# Bind("Complex") %>' Visible="false" ></asp:Label>
                                                                            ...
                                                                            <asp:Label ID="AnaNumber" runat="server" Text='<%# Bind("AnaNumber") %>' Visible="false"></asp:Label>
